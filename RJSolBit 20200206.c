...
/**/
  for (a = 0; a < 54; ++a)   // Search Almost Locked Candidates for 54 mini-Lines 3 Cell positions
  {
    if (B[Y = g[j[a][Z = 3]] & ~(g[j[a][4]] | g[j[a][5]] |
      g[j[a][6]] | g[j[a][7]] | g[j[a][8]])] == 2 ||
      B[Y = g[j[a][Z = 4]] & ~(g[j[a][3]] | g[j[a][5]] |
      g[j[a][6]] | g[j[a][7]] | g[j[a][8]])] == 2 ||
      B[Y = g[j[a][Z = 5]] & ~(g[j[a][3]] | g[j[a][4]] |
      g[j[a][6]] | g[j[a][7]] | g[j[a][8]])] == 2 ||
      B[Y = g[j[a][Z = 6]] & ~(g[j[a][3]] | g[j[a][4]] |
      g[j[a][5]] | g[j[a][7]] | g[j[a][8]])] == 2 ||
      B[Y = g[j[a][Z = 7]] & ~(g[j[a][3]] | g[j[a][4]] |
      g[j[a][5]] | g[j[a][6]] | g[j[a][8]])] == 2 ||
      B[Y = g[j[a][Z = 8]] & ~(g[j[a][3]] | g[j[a][4]] |
      g[j[a][5]] | g[j[a][6]] | g[j[a][7]])] == 2)
    {                        // 01
      int X;

      if ((g[j[a][X = 9]] == Y && ((g[j[a][10]] | g[j[a][11]] |
        g[j[a][12]] | g[j[a][13]] | g[j[a][14]]) & Y)) ||
        (g[j[a][X = 10]] == Y && ((g[j[a][9]] | g[j[a][11]] |
        g[j[a][12]] | g[j[a][13]] | g[j[a][14]]) & Y)) ||
        (g[j[a][X = 11]] == Y && ((g[j[a][9]] | g[j[a][10]] |
        g[j[a][12]] | g[j[a][13]] | g[j[a][14]]) & Y)) ||
        (g[j[a][X = 12]] == Y && ((g[j[a][9]] | g[j[a][10]] |
        g[j[a][11]] | g[j[a][13]] | g[j[a][14]]) & Y)) ||
        (g[j[a][X = 13]] == Y && ((g[j[a][9]] | g[j[a][10]] |
        g[j[a][11]] | g[j[a][12]] | g[j[a][14]]) & Y)) ||
        (g[j[a][X = 14]] == Y && ((g[j[a][9]] | g[j[a][10]] |
        g[j[a][11]] | g[j[a][12]] | g[j[a][13]]) & Y)))
      {
        int k[6] = {g[j[a][9]], g[j[a][10]], g[j[a][11]],
                   g[j[a][12]], g[j[a][13]], g[j[a][14]]};
                             // Backup and drop Almost Locked Candidates from removal Cells values
        g[j[a][9]] &= ~Y;
        g[j[a][10]] &= ~Y;
        g[j[a][11]] &= ~Y;
        g[j[a][12]] &= ~Y;
        ...
        g[j[a][X]] = Y;
#if RJ > 2
        printf ("%d) Almost Locked Candidates: Row %d wise %d @ %s %s => -%d @ %s %s %s %s %s\n",
          p, ROW (w[j[a][Z]][20]), b[Y], S[j[a][Z]], S[j[a][X]], b[Y],
          S[j[a][9 + (X < 10)]], S[j[a][10 + (X < 11)]], S[j[a][11 + (X < 12)]],
          S[j[a][12 + (X < 13)]], S[j[a][13 + (X < 14)]]);
#endif
        if (solve (p))
          return 1;
#if RJ > 2
        printf ("%d) Undo Almost Locked Candidates: Row %d wise %d @ %s %s <= +%d @ %s %s %s %s %s\n",
          p, ROW (w[j[a][Z]][20]), b[Y], S[j[a][Z]], S[j[a][X]], b[Y],
          S[j[a][9 + (X < 10)]], S[j[a][10 + (X < 11)]], S[j[a][11 + (X < 12)]],
          S[j[a][12 + (X < 13)]], S[j[a][13 + (X < 14)]]);
#endif
        ...
        prn ();
#endif
        return 0;            // Undo Almost Locked Candidates to removal Cells values
      }
    }
    if (B[Y = g[j[a][Z = 9]] & ~(g[j[a][10]] | g[j[a][11]] |
      g[j[a][12]] | g[j[a][13]] | g[j[a][14]])] == 2 ||
      B[Y = g[j[a][Z = 10]] & ~(g[j[a][9]] | g[j[a][11]] |
      g[j[a][12]] | g[j[a][13]] | g[j[a][14]])] == 2 ||
      B[Y = g[j[a][Z = 11]] & ~(g[j[a][9]] | g[j[a][10]] |
      g[j[a][12]] | g[j[a][13]] | g[j[a][14]])] == 2 ||
      B[Y = g[j[a][Z = 12]] & ~(g[j[a][9]] | g[j[a][10]] |
      g[j[a][11]] | g[j[a][13]] | g[j[a][14]])] == 2 ||
      B[Y = g[j[a][Z = 13]] & ~(g[j[a][9]] | g[j[a][10]] |
      g[j[a][11]] | g[j[a][12]] | g[j[a][14]])] == 2 ||
      B[Y = g[j[a][Z = 14]] & ~(g[j[a][9]] | g[j[a][10]] |
      g[j[a][11]] | g[j[a][12]] | g[j[a][13]])] == 2)
    {                        // 02
      int X;

      if ((g[j[a][X = 3]] == Y && ((g[j[a][4]] | g[j[a][5]] |
        g[j[a][6]] | g[j[a][7]] | g[j[a][8]]) & Y)) ||
        (g[j[a][X = 4]] == Y && ((g[j[a][3]] | g[j[a][5]] |
        g[j[a][6]] | g[j[a][7]] | g[j[a][8]]) & Y)) ||
        (g[j[a][X = 5]] == Y && ((g[j[a][3]] | g[j[a][4]] |
        g[j[a][6]] | g[j[a][7]] | g[j[a][8]]) & Y)) ||
        (g[j[a][X = 6]] == Y && ((g[j[a][3]] | g[j[a][4]] |
        g[j[a][5]] | g[j[a][7]] | g[j[a][8]]) & Y)) ||
        (g[j[a][X = 7]] == Y && ((g[j[a][3]] | g[j[a][4]] |
        g[j[a][5]] | g[j[a][6]] | g[j[a][8]]) & Y)) ||
        (g[j[a][X = 8]] == Y && ((g[j[a][3]] | g[j[a][4]] |
        g[j[a][5]] | g[j[a][6]] | g[j[a][7]]) & Y)))
      {
        int k[6] = {g[j[a][3]], g[j[a][4]], g[j[a][5]],
        ...
        printf ("%d) Almost Locked Candidates: Row %d wise %d @ %s %s => -%d @ %s %s %s %s %s\n",
          p, ROW (w[j[a][Z]][20]), b[Y], S[j[a][Z]], S[j[a][X]], b[Y],
          S[j[a][3 + (X < 4)]], S[j[a][4 + (X < 5)]], S[j[a][5 + (X < 6)]],
          S[j[a][6 + (X < 7)]], S[j[a][7 + (X < 8)]]);
#endif
        if (solve (p))
          return 1;
#if RJ > 2
