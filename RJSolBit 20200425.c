...
int solve (int p)
{
  ...
  for (; y < 27; ++y)        // Check Zero state Unit wise
  {
    ...
    {                        // Check Zero state digit wise
      ...
      {                      // Check digit Unit wise
        ...
        for (X = 0; x = a & -a; ++X, a -= x)
        {                    // Assign digit Cell positions and Cell values
          A[X] = l[y][b[x] - 1];
          z |= g[A[X]];
        }
        if (Z > B[z])
    ...
    for (y = 0; y < 2; ++y)  // Search either away Line or away Box 6 Cell position wise
    {
      ...
      {                      // Search Almost Locked Pair 54 mini-Lines away Line/Box 6 Cell positions wise
        if (!g[j[a][A]] || B[Y = g[j[a][A]] & ~(g[j[a][W[26][y] +
          ...
          g[j[a][Z = W[30][!y]]] != Y && g[j[a][Z = W[31][!y]]] != Y) ||
          (!((g[K[0] = j[a][W[26][!y] + (Z < W[27][!y])]] |
          g[K[1] = j[a][W[27][!y] + (Z < W[28][!y])]] |
          g[K[2] = j[a][W[28][!y] + (Z < W[29][!y])]] |
          g[K[3] = j[a][W[29][!y] + (Z < W[30][!y])]] |
          g[K[4] = j[a][W[30][!y] + (Z < W[31][!y])]]) & Y) &&
          B[g[j[a][A]]] < 3))// Found Almost Locked Pair Line/Box wise
          continue;
        ...
        g[K[4]] &= ~Y;
#if RJ > 2
        printf ("%d) Almost Locked Pair: %s %d wise %d @ b%dr%dc%d %s b%d%s\n=> -%d @ %s %s %s %s %s",
          p, a < 27 ? "Row" : "Column",
          a < 27 ? ROW (w[j[a][y ? Z : A]][20]) : COL (w[j[a][y ? Z : A]][20]),
          b[Y], BOX (j[a][y ? A : Z]),
          ROW (w[j[a][0]][20] | w[j[a][1]][20] | w[j[a][2]][20]),
          COL (w[j[a][0]][20] | w[j[a][1]][20] | w[j[a][2]][20]), S[j[a][y ? Z : A]],
          BOX (j[a][y ? A : Z]), S[j[a][y ? A : Z]],
        ...
        if (solve (p))
          return 1;
#if RJ > 2
        printf ("%d) Undo Almost Locked Pair: %s %d wise %d @ b%dr%dc%d %s b%d%s\n<= +%d @ %s %s %s %s %s",
          p, a < 27 ? "Row" : "Column",
          a < 27 ? ROW (w[j[a][y ? Z : A]][20]) : COL (w[j[a][y ? Z : A]][20]),
          b[Y], BOX (j[a][y ? A : Z]),
          ROW (w[j[a][0]][20] | w[j[a][1]][20] | w[j[a][2]][20]),
      ...
      {                      // Search 1st Cell position away Line/Box wise
        if (!g[j[a][A]])
          continue;          // Skip for 1st Cell position not unsolved
        for (L = A + 1; L < W[32][y]; ++L)
        {                    // Search 2nd Cell position away Line/Box wise
          if (!g[j[a][L]] || B[Y = (g[j[a][A]] | g[j[a][L]]) &
            ~(g[j[a][W[26][y] + (A < W[27][y]) + (L < W[28][y])]] |
            g[j[a][W[27][y] + (A < W[28][y]) + (L < W[29][y])]] |
            g[j[a][W[28][y] + (A < W[29][y]) + (L < W[30][y])]] |
            g[j[a][W[29][y] + (A < W[30][y]) + (L < W[31][y])]])] != 3)
          ...
          {                  // Search 3rd Cell position away Box/Line wise
            if (!g[j[a][M]] || B[g[j[a][M]]] > 3)
              continue;      // Skip for either 3rd Cell position not unsolved; or 3rd Cell values > three digits
            for (N = M + 1; N < W[32][!y]; ++N)
            {                // Search 4th Cell position away Box/Line wise
              if (!g[j[a][N]] || (g[j[a][M]] | g[j[a][N]]) != Y ||
                             // Check 4th Cell position unsolved; and 3rd and 4th Cell values = 1st and 2nd Cell values; and
                (!((g[K[0] = j[a][W[26][!y] + (M < W[27][!y]) + (N < W[28][!y])]] |
                g[K[1] = j[a][W[27][!y] + (M < W[28][!y]) + (N < W[29][!y])]] |
                g[K[2] = j[a][W[28][!y] + (M < W[29][!y]) + (N < W[30][!y])]] |
                g[K[3] = j[a][W[29][!y] + (M < W[30][!y]) + (N < W[31][!y])]]) & Y) &&
                B[g[j[a][A]] | g[j[a][L]]] < 4))
                continue;    // Almost Locked Triple values in removal Cell positions
              int k[6] = {g[j[a][A]], g[j[a][L]], g[K[0]], g[K[1]], g[K[2]], g[K[3]]};
              ...
              g[K[3]] &= ~Y;
#if RJ > 2
              printf ("%d) Almost Locked Triple: %s %d wise %d @ b%dr%dc%d r%dc%d b%d%s b%d%s\n=> -%d @ %s %s %s %s",
                p, a < 27 ? "Row" : "Column",
              ...
              if (solve (p))
                return 1;
#if RJ > 2
              printf ("%d) Undo Almost Locked Triple: %s %d wise %d @ b%dr%dc%d r%dc%d b%d%s b%d%s\n<= +%d @ %s %s %s %s",
                p, a < 27 ? "Row" : "Column",
                a < 27 ? ROW (w[j[a][y ? M : A]][20]) : COL (w[j[a][y ? M : A]][20]),
                b[Y], BOX (j[a][y ? A : M]),
                ROW (w[j[a][0]][20] | w[j[a][1]][20] | w[j[a][2]][20]),
        ...
        {                    // Search 2nd Cell position 54 mini-Lines away Line/Box wise
          ...
          {                  // Search 3rd Cell position 54 mini-Lines away Line/Box wise
            if (!g[j[a][M]] || B[Y = (g[j[a][A]] | g[j[a][L]] | g[j[a][M]]) &
              ~(g[j[a][W[26][y] + (A < W[27][y]) + (L < W[28][y]) + (M < W[29][y])]] |
              g[j[a][W[27][y] + (A < W[28][y]) + (L < W[29][y]) + (M < W[30][y])]] |
              g[j[a][W[28][y] + (A < W[29][y]) + (L < W[30][y]) + (M < W[31][y])]])] != 4 ||
              !(g[j[a][A]] & Y) || !(g[j[a][L]] & Y) || !(g[j[a][M]] & Y))
              continue;      // Skip for either 3rd Cell position not unsolved; or 1st, 2nd and 3rd Cells values not four digits; or Almost Locked Quad values not in either 1st or 2nd or 3rd Cell positions
              ...
              {              // Search 5th Cell position 54 mini-Lines away Box/Line wise
                ...
                {            // Search 6th Cell position 54 mini-Lines away Box/Line wise
                  if (!g[j[a][Z]] || (g[j[a][N]] | g[j[a][X]] | g[j[a][Z]]) != Y ||
                             // Check for 6th Cell position unsolved; and 4th, 5th and 6th Cells values is 1st, 2nd and 3rd Cells values; and
                  ...
                  g[K[2]] &= ~Y;
#if RJ > 2
                  printf ("%d) Almost Locked Quad: %s %d wise %d @ b%dr%dc%d r%dc%d b%d%s b%d%s b%d%s\n=> -%d @ %s %s %s",
                    p, a < 27 ? "Row" : "Column",
                  ...
                  if (solve (p))
                    return 1;
#if RJ > 2
                  printf ("%d) Undo Almost Locked Quad: %s %d wise %d @ b%dr%dc%d r%dc%d b%d%s b%d%s b%d%s\n<= +%d @ %s %s %s",
                    p, a < 27 ? "Row" : "Column",
                    a < 27 ? ROW (w[j[a][y ? N : A]][20]) : COL (w[j[a][y ? N : A]][20]),
                    b[Y], BOX (j[a][y ? A : N]),
                    ROW (w[j[a][0]][20] | w[j[a][1]][20] | w[j[a][2]][20]),
  ...
  for (y = p; y < q - 1; ++y)// Search W-Wing Type 1, Type 2 and W-Ring 1st Wing Cell position unsolved Cell positions wise
  {
    if (B[g[r[y]]] > 2)
        ...
        {                    // Search W-Wing Type 1 SL Wings wise
          ...
          {                  // (W-Wing Type 1 02, W-Ring 02) Check SL ERI wise
            ...
            printf ("%d) W-%cing Type 1 Grid: %d @ %s %s ERI %d @ b%d%s => -%d @ %s %s",
              p, B[N] < 2 ? 'W' : 'R', b[g[K[0]]], S[K[0]], S[K[1]],
            ...
            if (solve (p))
              return 1;
#if RJ > 2
            printf ("%d) Undo W-%cing Type 1 Grid: %d @ %s %s ERI %d @ b%d%s <= +%d @ %s %s",
              p, B[N] < 2 ? 'W' : 'R', b[g[K[0]]], S[K[0]], S[K[1]],
              b[N], BOX (K[3 + a]), S[K[3 + a]], b[K[2]], S[K[3]], S[K[4]]);
            if (B[N] > 1)
              printf (" r%dc%d r%dc%d",
  ...
  for (a = p; a < q; ++a)    // Search Strong Wing Type 1 and Strong Ring Type 1 Apex Cell unsolved Cell positions wise
  {
    if (!(g[w[r[a]][0]] | g[w[r[a]][1]] | g[w[r[a]][2]] |
    ...
    for (; K[1] < 6; ++K[1]) // Search 1st Wing Cell position Row wise
    {
      if (!g[K[2] = w[K[0]][K[1]]] ||
        ...
        !(K[6] = g[K[0]] & g[K[2]] & ~(g[w[K[0]][6]] |
        g[w[K[0]][7]] | g[w[K[2]][6]] | g[w[K[2]][7]] |
        g[Y = w[K[0]][K[1] < 3 ? 3 : 0]] | g[w[Y][6]] | g[w[Y][7]])))
        continue;            // No conjugate pair digit in Apex and 1st Wing Cells values
      for (K[3] = 14; K[3] < 20; ++K[3])
      {                      // Search 2nd Wing Cell position Column wise
        if (!g[K[4] = w[K[0]][K[3]]] ||
                             // Skip for either Strong Wing 2nd Wing Cell position not unsolved; or
          !(K[7] = g[K[0]] & g[K[4]] & ~(g[w[K[0]][12]] |
          g[w[K[0]][13]] | g[w[K[4]][12]] | g[w[K[4]][13]] |
          g[Y = w[K[0]][K[3] < 17 ? 17 : 14]] | g[w[Y][12]] | g[w[Y][13]])) ||
                             // No conjugate pair digit in Apex and 2nd Wing Cells values; or
          ...
          !(K[8] = g[K[2]] & g[K[5]] & ~(g[w[K[2]][12]] |
          g[w[K[2]][13]] | g[w[K[5]][12]] | g[w[K[5]][13]] |
          g[Y = w[K[2]][K[3] < 17 ? 17 : 14]] | g[w[Y][12]] | g[w[Y][13]])) ||
                             // No conjugate pair digit in 1st Wing and removal Cells values; or
          !(K[9] = g[K[4]] & g[K[5]] & ~(g[w[K[4]][6]] |
          g[w[K[4]][7]] | g[w[K[5]][6]] | g[w[K[5]][7]] |
          g[Y = w[K[4]][K[1] < 3 ? 3 : 0]] | g[w[Y][6]] | g[w[Y][7]])))
          continue;          // No conjugate pair digit in 2nd Wing and removal Cells values
        if (Y = K[8] & K[9])
        {                    // Check Strong Wing Type 1 for conjugate pair digit in 1st Wing and removal Cells values same as 2nd Wing and removal Cells values
          Z = g[K[5]];       // Backup and drop from removal Cell values
          g[K[5]] = Y;
#if RJ > 2
          printf ("%d) Strong Wing Type 1: SL %d @ r%dc%d %d @ r%dc%d %d @ r%dc%d r%dc%d => -%d @ %s\n",
          ...
          if (solve (p))
            return 1;
#if RJ > 2
          printf ("%d) Undo Strong Wing Type 1: SL %d @ r%dc%d %d @ r%dc%d %d @ r%dc%d r%dc%d <= +%d @ %s\n",
            p, b[K[6]], ROW (w[K[0]][20] | w[K[2]][20]), COL (w[K[0]][20] | w[K[2]][20]),
            b[K[7]], ROW (w[K[0]][20] | w[K[4]][20]), COL (w[K[0]][20] | w[K[4]][20]),
            b[Y], ROW (w[K[2]][20] | w[K[5]][20]), COL (w[K[2]][20] | w[K[5]][20]),
            ROW (w[K[4]][20] | w[K[5]][20]), COL (w[K[4]][20] | w[K[5]][20]),
        ...
        if (K[0] > K[2] || K[0] > K[4] ||
                             // Skip Strong Ring Type 1 for either duplicate search; or
        ...
        if (solve (p))
          return 1;
#if RJ > 2
        printf ("%d) Undo Strong Ring Type 1: SL %d @ r%dc%d %d @ r%dc%d %d @ r%dc%d %d @ r%dc%d\n<=",
          p, b[K[6]], ROW (w[K[0]][20] | w[K[2]][20]), COL (w[K[0]][20] | w[K[2]][20]),
          b[K[7]], ROW (w[K[0]][20] | w[K[4]][20]), COL (w[K[0]][20] | w[K[4]][20]),
          b[K[8]], ROW (w[K[2]][20] | w[K[5]][20]), COL (w[K[2]][20] | w[K[5]][20]),
          b[K[9]], ROW (w[K[4]][20] | w[K[5]][20]), COL (w[K[4]][20] | w[K[5]][20]));
        ...
        prn ();
#endif
        return 0;            // Undo Strong Ring Type 1 removal Cells values
      }
    }
  }
  for (a = p; a < q; ++a)    // Search Strong Wing Type 2 and Strong Ring Type 2 Apex Cell unsolved Cell positions wise
  {
    int K[11] = {r[a]};      // Assign Apex Cell position
    ...
    for (y = 0; y < 2; ++y)  // Search Strong Wing Type 2 and Strong Ring Type 2 Chute wise
    {
      ...
      {                      // Search 1st Wing Cell position Line wise
        if (!g[K[2] = w[K[0]][K[1]]] ||
                             // Skip for either 1st Wing Cell position not unsolved; or
          !(K[6] = (g[K[0]] & g[K[2]] & ~(g[w[K[0]][W[3][y]]] |
          g[w[K[0]][W[4][y]]] | g[w[K[2]][W[3][y]]] | g[w[K[2]][W[4][y]]] |
          g[Y = w[K[0]][W[K[1] < W[5][y] ? 5 : 1][y]]] |
        ...
        {                    // Search 2nd Wing Cell position Box wise but not in 1st Wing Line
          if (!g[K[4] = w[K[0]][K[3]]] ||
                             // Skip for either Strong Wing 2nd Wing Cell position not unsolved; or
            !(K[7] = (g[K[0]] & g[K[4]] & ~(g[w[K[0]][W[3][y]]] |
            g[w[K[0]][W[4][y]]] | g[w[K[4]][W[3][y]]] | g[w[K[4]][W[4][y]]] |
            g[Y = w[K[0]][W[K[3] == W[6][y] || K[3] == W[7][y] ||
            K[3] == W[8][y] ? 4 : 3][!y]]] | g[w[Y][W[3][y]]] | g[w[Y][W[4][y]]]))) ||
                             // Conjugate pair digit not in Apex and 2nd Wing Cells values; or
            (K[6] & K[7]))   // Conjugate pair digit in Apex and 1st Wing Cells values same as Apex and 2nd Wing Cells values
            continue;
          for (X = K[10] = W[K[1] < W[5][y] ? 1 : 5][y]; X < K[10] + 3; ++X)
          {
            if (!g[K[5] = w[K[4]][K[1]]] ||
                             // Skip for removal Cell not unsolved; or
              !(K[8] = g[K[2]] & g[K[5]] & ~(g[w[K[2]][W[3][y]]] |
              g[w[K[2]][W[4][y]]] | g[w[K[5]][W[3][y]]] | g[w[K[5]][W[4][y]]] |
              g[Y = w[K[2]][W[K[3] == W[6][y] || K[3] == W[7][y] ||
              K[3] == W[8][y] ? 4 : 3][!y]]] | g[w[Y][W[3][y]]] | g[w[Y][W[4][y]]])) ||
                             // No conjugate pair digit in 1st Wing and removal Cells values; or
              !(K[9] = g[K[4]] & g[K[5]] & ~(g[w[K[4]][W[3][y]]] |
              g[w[K[4]][W[4][y]]] | g[w[K[5]][W[3][y]]] | g[w[K[5]][W[4][y]]] |
              g[Y = w[K[4]][W[X < W[5][y] ? 5 : 1][y]]] | g[w[Y][W[3][y]]] | g[w[Y][W[4][y]]])))
              continue;      // No conjugate pair digit in 2nd Wing and removal Cells values
            if (Y = K[8] & K[9])
            {
              Z = g[K[5]];   // Backup and drop from removal Cell values
              g[K[5]] = Y;
#if RJ > 2
              printf ("%d) Strong Wing Type 2: %d @ r%dc%d %d @ %s %s %d @ %s %s %d @ r%dc%d => -%d @ %s\n",
                p, b[K[6]], ROW (w[K[0]][20] | w[K[2]][20]),
                COL (w[K[0]][20] | w[K[2]][20]), b[K[7]], S[K[0]], S[K[4]],
                b[K[8]], S[K[2]], S[K[5]], b[K[9]], ROW (w[K[4]][20] | w[K[5]][20]),
                COL (w[K[4]][20] | w[K[5]][20]), b[Z - Y], S[K[5]]);
#endif
              if (solve (p))
                return 1;
#if RJ > 2
              printf ("%d) Undo Strong Wing Type 2: %d @ r%dc%d %d @ %s %s %d @ %s %s %d @ r%dc%d <= +%d @ %s\n",
                p, b[K[6]], ROW (w[K[0]][20] | w[K[2]][20]),
                COL (w[K[0]][20] | w[K[2]][20]), b[K[7]], S[K[0]], S[K[4]],
                b[K[8]], S[K[2]], S[K[5]], b[K[9]], ROW (w[K[4]][20] | w[K[5]][20]),
                COL (w[K[4]][20] | w[K[5]][20]), b[Z - Y], S[K[5]]);
      ...
      {                      // Search 1st Wing Cell position Line wise
        ...
        {                    // Search 2nd Wing Cell position Box wise but not in 1st Wing Line
          ...
          if (K[2] > K[0] && K[4] > K[0] &&
            ...
            {                // Search XY-Ring Type 2 3rd Wing Cell position 1st and 2nd Wing Cells common Cell positions wise
              ...
              printf ("%d) XY-Ring Type 2: %d @ r%dc%d r%dc%d => -%d @ r%dc%d => -%d @ r%dc%d\n=> -%d @ %s %s %s %s %s %s %s",
                ...
                COL (w[K[4]][20] | w[K[5]][20]), b[g[K[0]] & g[K[2]]],
          ...
          {                  // Search XY-Wing Type 2 Transport and XYZ-Wing Transport
            ...
            {
              M = w[K[4]][N];
              if (((k[29] = LB3 (K[4], w[K[4]][K[1]], w[K[4]][K[7]], y) & K[5]) ||
                (LB3 (w[K[0]][K[7]], w[M][K[7]], w[K[4]][K[7]], y) & K[5])) &&
                ((g[M] | g[w[M][W[3][y]]] | g[w[M][W[4][y]]] |
                (k[29] && (w[K[0]][20] & w[K[4]][20] & W[15][y]) &&
              ...
              {              // Line 01, Box 02, Reduced Line 1a
                ...
                g[w[M][W[3][y]]] &= ~K[5];
                g[w[M][W[4][y]]] &= ~K[5];
                if (k[29] && (w[K[0]][20] & w[K[4]][20] & W[15][y]) &&
                  (~(g[w[K[4]][W[3][y]]] | g[w[K[4]][W[4][y]]]) & K[5]))
                {            // Reduced Line 1a
                  k[3] = g[w[K[0]][W[1][!y]]];
                  k[4] = g[w[K[0]][W[18][!y]]];
                ...
                printf ("%d) XYZ-Wing Transport:%s%s %d @ %s %s %s SL %d @ %s %d => -%d @ r%dc%d",
                  p, k[3] + 1 ? " Reduced " : " ", k[29] ? R_C : "Box",
                  b[g[K[0]]], S[K[0]], S[K[2]], S[K[4]], b[K[5]], k[29] ? R_C : "Box",
                  k[29] ? RCN (w[K[4]][K[7]]) : BOX (w[K[4]][K[7]]), b[K[5]],
              ...
              if (((g[w[K[0]][K[7]]] | g[w[K[0]][K[7] + 1]] | g[w[K[0]][K[7] + 2]]) & K[5]) &&
                ((k[29] = LB3 (w[K[4]][N], w[X][K[7]], w[X][K[1]], y) & K[5]) ||
              ...
              {              // Line 03, Box 04
                ...
                printf ("%d) XYZ-Wing Transport: %s %d @ %s %s %s SL %d @ %s %d => -%d @ r%dc%d\n",
                  p, k[29] ? R_C : "Box", b[g[K[0]]], S[K[0]], S[K[2]], S[K[4]], b[K[5]],
                  k[29] ? R_C : "Box", k[29] ? RCN (w[K[4]][K[7]]) : BOX (w[K[4]][K[7]]),
            ...
            {                // Line Ring 05, Box Ring 06, Reduced Line Ring 07, 08, 09
              ...
              k[15] = k[29] && (B[g[K[0]]] < 3 || w[K[0]][K[8]] == M) &&
                      ~(g[w[M][W[3][y]]] | g[w[M][W[4][y]]]) & K[5];
              k[16] = k[29] && ~(g[w[Y = w[K[2]][K[8]]][W[3][y]]] | g[w[Y][W[4][y]]]) & K[5];
              if (k[15])
              ...
              printf ("%d) XY%s Transport:%s%s Ring %d @ %s %s %s\nSL %d @ %s %d => -%d @ %s %s %s %s",
                ...
                k[15] ? " Reduced " : " ", k[29] ? R_C : "Box", b[g[K[2]] | g[K[4]]],
                S[K[0]], S[K[2]], S[K[4]], b[K[5]], k[29] ? R_C : "Box",
                k[29] ? RCN (M) : BOX (M), b[K[5]], S[w[K[2]][W[3][y]]],
            ...
            for (Y = W[1][!y]; Y < W[2][!y]; ++Y)
            {
              ...
              {              // Line Ring 10, 12, ERI Ring 11, 13
                ...
                printf ("%d) XY%s Transport: %s Ring %d @ %s %s %s SL value %d %s %d between Cell %s and Cell %s\n=> -%d @ %s",
                  p, B[g[K[0]]] < 3 ? "-Wing Type 2" : "Z-Wing", k[29] ? R_C : "ERI",
                  b[g[K[2]] | g[K[4]]], S[K[0]], S[K[2]], S[K[4]], b[K[5]],
                  k[29] ? R_C : "ERI", k[29] ? RCN (X) : BOX (X), S[X], S[Z], b[K[5]], S[M]);
                if (B[g[K[0]]] < 3 || w[K[0]][K[8]] == M)
                {
                  if (k[29])
                    ...
                    printf (" %s %s %s %s %s", S[X], S[Z], S[w[Z][K[7]]],
                      S[w[Z][K[7] + 1]], S[w[Z][K[7] + 2]]);
                  if (B[g[K[0]]] > 2)
                ...
                printf ("\n=> -%d @ r%dc%d => -%d @ %s %s %s %s %s %s %s",
                  ...
                  w[w[K[0]][K[7] + 2]][20]), b[g[K[4]] ^ K[5]],
                  S[w[K[0]][W[3][y]]], S[w[K[0]][W[4][y]]], S[w[K[4]][W[3][y]]],
                  S[w[K[4]][W[4][y]]], S[M], S[w[M][W[3][y]]], S[w[M][W[4][y]]]);
                if (w[K[0]][K[8]] == M)
                  printf (" r%dc%d", ROW ((k[29] ? w[w[Z][W[3][!y]]][20] |
                    w[w[Z][W[4][!y]]][20] : w[Z][20]) | w[w[K[4]][A]][20] |
                    w[w[w[K[4]][A]][W[3][!y]]][20] | w[w[w[K[4]][A]][W[4][!y]]][20]),
                    COL ((k[29] ? w[w[Z][W[3][!y]]][20] |
                    w[w[Z][W[4][!y]]][20] : w[Z][20]) | w[w[K[4]][A]][20] |
                    w[w[w[K[4]][A]][W[3][!y]]][20] | w[w[w[K[4]][A]][W[4][!y]]][20]));
                printf ("\n");
#endif
                ...
                if (B[g[K[0]]] < 3 || w[K[0]][K[8]] == M)
                {
                  if (k[29])
                    ...
                    printf (" %s %s %s %s %s", S[X], S[Z], S[w[Z][K[7]]],
                      S[w[w[Z][K[7]]][W[3][y]]], S[w[w[Z][K[7]]][W[4][y]]]);
                  if (B[g[K[0]]] > 2)
                    printf (" %s", S[w[K[4]][K[1]]]);
                  printf (" %s %s %s %s %s %s %s", S[w[K[2]][K[8]]],
                    S[w[K[2]][A]], S[w[w[K[2]][A]][W[3][!y]]], S[w[w[K[2]][A]][W[4][!y]]],
                ...
                printf ("\n<= +%d @ r%dc%d <= +%d @ %s %s %s %s %s %s %s",
                  ...
                  w[w[K[2]][W[3][y]]][20] | w[w[K[2]][W[4][y]]][20] |
                  w[w[K[0]][K[7]]][20] | w[w[K[0]][K[7] + 1]][20] |
                  w[w[K[0]][K[7] + 2]][20]), b[g[K[4]] ^ K[5]], S[w[K[0]][W[3][y]]],
                  S[w[K[0]][W[4][y]]], S[w[K[4]][W[3][y]]], S[w[K[4]][W[4][y]]],
                  S[M], S[w[M][W[3][y]]], S[w[M][W[4][y]]]);
                if (w[K[0]][K[8]] == M)
                  printf (" r%dc%d", ROW ((k[29] ? w[w[Z][W[3][!y]]][20] |
                ...
                for (A = 3; A < 5; ++A)
                  ...
                  {          // Line 14, ERI 15
                    ...
                    printf ("%d) XYZ-Wing Transport: %s %d @ %s %s %s SL value %d %s %d between %s %s and %s %s\n=> -%d @ %s\n",
                      p, k[29] ? R_C : "ERI", b[g[K[0]]], S[K[0]], S[K[2]], S[K[4]], b[K[5]],
                      k[29] ? R_C : "ERI", k[29] ? RCN (X) : BOX (X), k[29] ? "Cell" : "ERI",
                      S[X], k[29] ? "Cell" : "ERI", S[Z], b[K[5]], S[L]);
#endif
                    if (solve (p))
                      return 1;
#if RJ > 2
                ...
                if (!M || B[g[K[0]]] < 3)
                  for (A = K[7]; A < K[7] + 3; ++A)
                    ...
                    {        // Line 16, ERI 17, 18
                      k[0] = g[L];
                      g[L] &= ~K[5];
                      if (!k[29] && (B[g[K[0]]] < 3 || w[K[0]][K[8]] == w[K[4]][N]))
                      {      // ERI 18
                        k[1] = g[w[K[2 << M]][Y]];
                        g[w[K[2 << M]][Y]] &= ~K[5];
                      }
                ...
                for (A = 3; A < 5; ++A)
                  ...
                  {          // Line 19, 21, 23, 25 ERI 20, 22, 24, 26
                    ...
                    printf ("%d) XY%s Transport: %s %d @ %s %s %s SL value %d %s %d between Cell %s and Cell %s\n=> -%d @ %s",
                      p, B[g[K[0]]] < 3 ? "-Wing Type 2" : "Z-Wing",
                      k[29] ? R_C : "ERI", b[g[K[2]] | g[K[4]]],
                      S[K[0]], S[K[2]], S[K[4]], b[K[5]], k[29] ? R_C : "ERI",
                      k[29] ? RCN (X) : BOX (X), S[X], S[Z], b[K[5]], S[L]);
                    if (k[1] + 1)
                    {
...
// WXYZ-Wing Type 2a, Type 2b and Type 3 Transport
          ...
          if (B[g[K[0]]] > 2)// Check Almost Locked Set move Type 2a for Apex Cell values three digits
          {
            ...
            {                // Search Almost Locked Set move Type 2a 3rd Wing Cell position 1st Wing Box and 2nd Wing Line wise
              ...
              g[w[K[4 >> L]][W[3][y]]] &= ~g[K[4 >> L]];
              g[w[K[4 >> L]][W[4][y]]] &= ~g[K[4 >> L]];
              if (B[g[K[5]]] < 3)
              {
                g[Z] &= ~X;
                g[w[Z][W[3][y]]] &= ~X;
              ...
              printf ("%d) Almost Locked Set move Type 2a: %d @ r%dc%d r%dc%d => -%d @ r%dc%d",
                ...
                COL (w[K[0]][20] | w[K[4]][20]), ROW (w[K[2]][20] | w[K[5]][20]),
                COL (w[K[2]][20] | w[K[5]][20]), b[g[K[4 >> L]]],
              ...
              if (solve (p))
                return 1;
#if RJ > 2
              printf ("%d) Undo Almost Locked Set move Type 2a: %d @ r%dc%d r%dc%d <= +%d @ r%dc%d",
                p, b[g[K[2]] | g[K[4]]], ROW (w[K[0]][20] | w[K[4]][20]),
                COL (w[K[0]][20] | w[K[4]][20]), ROW (w[K[2]][20] | w[K[5]][20]),
                COL (w[K[2]][20] | w[K[5]][20]), b[g[K[4 >> L]]],
                ROW (w[w[K[4 >> L]][W[3][y]]][20] | w[w[K[4 >> L]][W[4][y]]][20]),
