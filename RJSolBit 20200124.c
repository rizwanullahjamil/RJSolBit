...
static const int b[512] = {  // Bitwise to digit Cell values
  ...
  { 4, 5, 7, 8, 0, 1, 2, 3, 6}, { 4, 6, 7, 8, 0, 1, 2, 3, 5}, { 5, 6, 7, 8, 0, 1, 2, 3, 4}},
           j[54][15] = {     // 3 Locked value Cell positions and peer 6 Line + 6 Box Cell positions for 54 mini-Lines
            ...
            for (Y = W[1][!y]; Y < W[2][!y]; ++Y)
            {
              ...
              for (A = K[7]; A < K[7] + 3; ++A)
                if (((k[75] = LN1 (w[L = w[K[0]][A]][Y], w[K[4]][Y], w[K[2]][Y], y) & K[5]) ||
                  ...
                  (B[g[K[0]]] < 3 || w[K[0]][K[8]] == w[K[4]][N]) ? g[w[K[2]][Y]] : 0)) & K[5]))
                {            // Line 14, ERI 15, 16
                  k[0] = g[L];
                  g[L] &= ~K[5];
              ...
              for (M = 0; M < 2; ++M)
              {
                ...
                {            // ERI 29, 30
                  g[w[K[4 >> M]][Y]] -= K[5];
#if RJ > 2
                  printf ("%d) XYZ-Wing Transport: ERI %d @ %s %s %s SL ERI %d @ b%d%s => -%d @ %s\n",
                  ...
                  if (solve (p))
                    return 1;
#if RJ > 2
                  printf ("%d) Undo XYZ-Wing Transport: ERI %d @ %s %s %s SL ERI %d @ b%d%s <= +%d @ %s\n",
                    p, b[g[K[0]]], S[K[0]], S[K[2]], S[K[4]], b[K[5]],
                    BOX (w[K[2 << M]][Y]), S[w[K[2 << M]][Y]], b[K[5]], S[w[K[4 >> M]][Y]]);
#endif
                  g[w[K[4 >> M]][Y]] |= K[5];
...
/**/
          if (B[g[K[0]]] < 3)
            continue;        // Skip for Apex Cell values < three digits
          int L,
              M,
              X;

          Y = ((g[w[K[0]][K[7]]] | g[w[K[0]][K[7] + 1]] | g[w[K[0]][K[7] + 2]]) & K[5]) &&
                             // Wing Cells common value in XYZ-Wing Hybrid removal Cells values; and
              ((L = g[w[K[4]][K[1]]] & ~(g[w[K[2]][K[8]]] | g[w[K[2]][W[1][!y]]] |
              g[w[K[2]][W[18][!y]]] | g[w[K[2]][W[19][!y]]] | g[w[K[2]][W[20][!y]]] |
              g[w[K[2]][W[21][!y]]] | g[w[K[2]][W[22][!y]]]) & K[5]) ||
                             // Either Wing Cells common value in 1st and 2nd Wing Line intersection; or
              (LB3 (K[2], w[K[4]][K[1]], w[K[2]][K[8]], y) & K[5]));
                             // 2nd Wing Box
          Z = ((g[X = w[K[0]][K[8]]] | g[w[X][W[3][y]]] | g[w[X][W[4][y]]]) & K[5]) &&
                             // Wing Cells common value in XYZ-Wing Hybrid removal Cells value; and
              ((M = LB3 (K[4], w[K[4]][K[1]], w[K[4]][K[7]], y) & K[5]) ||
                             // Either 2nd Wing Line; or
              (LB3 (w[K[0]][K[7]], w[X][K[8]], w[K[4]][K[7]], y) & K[5]));
                             // Other Box
          if (Y | Z)
          {
            int k[6];
...
#if RJ > 2
            printf ("%d)%sXYZ-Wing Hybrid: %d @ r%dc%d %s %s Hybrid %d @ r%dc%d => -%d @",
              p, Y && Z ? " Dual " : " ", b[g[K[2]] | g[K[4]]],
              ROW (w[K[0]][20] | w[K[2]][20]), COL (w[K[0]][20] | w[K[2]][20]), S[K[4]],
              Y && Z ? "Dual" : (L || M ? (y ? "Column wise" : "Row wise") : "Box wise"),
              b[K[5]], ROW (w[w[K[4]][K[6]]][20] | w[w[K[4]][K[6] + 1]][20] |
              w[w[K[4]][K[6] + 2]][20]), COL (w[w[K[4]][K[6]]][20] |
            ...
            if (Y)
              printf (" r%dc%d", ROW (w[w[K[0]][K[7]]][20] | w[w[K[0]][K[7] + 1]][20] |
                ...
                w[w[K[0]][K[7] + 1]][20] | w[w[K[0]][K[7] + 2]][20]));
            if (Z)
              printf (" r%dc%d", ROW (w[X][20] | w[w[X][W[3][y]]][20] |
                w[w[X][W[4][y]]][20]), COL (w[X][20] | w[w[X][W[3][y]]][20] |
                w[w[X][W[4][y]]][20]));
            printf ("\n");
#endif
            if (solve (p))
              return 1;
#if RJ > 2
            printf ("%d) Undo%sXYZ-Wing Hybrid: %d @ r%dc%d %s %s Hybrid %d @ r%dc%d <= +%d @",
              p, Y && Z ? " Dual " : " ", b[g[K[2]] | g[K[4]]],
              ROW (w[K[0]][20] | w[K[2]][20]), COL (w[K[0]][20] | w[K[2]][20]), S[K[4]],
              Y && Z ? "Dual" : (L || M ? (y ? "Column wise" : "Row wise") : "Box wise"),
              b[K[5]], ROW (w[w[K[4]][K[6]]][20] | w[w[K[4]][K[6] + 1]][20] |
...
/**
          ...
          {                  // Check Wing Cells common value in XYZ-Wing Hybrid Cells values
            ...
            if ((g[Z = w[K[0]][K[8]]] | g[w[Z][W[3][y]]] | g[w[Z][W[4][y]]]) &
              ~(g[w[K[4]][K[7]]] | g[w[K[4]][K[7] + 1]] | g[w[K[4]][K[7] + 2]]) & K[5])
            {                // Backup XYZ-Wing Hybrid 2nd Wing Line wise and remove Wing Cells common value from removal Cells values
              k[1] = g[Z];
              k[4] = g[w[Z][W[3][y]]];
              k[5] = g[w[Z][W[4][y]]];
              g[Z] &= ~K[5];
            ...
            if ((k[0] & k[1]) + 1)
            {
              ...
              printf ("%d)%sXYZ-Wing Hybrid: %d @ r%dc%d %s %s Hybrid %d @ r%dc%d => -%d @",
                p, (k[0] | k[1]) + 1 ? " Dual " : " ", b[g[K[2]] | g[K[4]]],
                ROW (w[K[0]][20] | w[K[2]][20]), COL (w[K[0]][20] | w[K[2]][20]), S[K[4]],
                (k[0] | k[1]) + 1 ? "Dual" : (k[0] + 1 ? "Box wise" : (y ? "Column wise" : "Row wise")),
                b[K[5]], ROW (w[w[K[4]][K[6]]][20] | w[w[K[4]][K[6] + 1]][20] |
                w[w[K[4]][K[6] + 2]][20]), COL (w[w[K[4]][K[6]]][20] |
                w[w[K[4]][K[6] + 1]][20] | w[w[K[4]][K[6] + 2]][20]), b[K[5]]);
              if (k[0] + 1)
                printf (" r%dc%d", ROW (w[w[K[0]][K[7]]][20] | w[w[K[0]][K[7] + 1]][20] |
                  ...
                  w[w[K[0]][K[7] + 1]][20] | w[w[K[0]][K[7] + 2]][20]));
              if (k[1] + 1)
                printf (" r%dc%d", ROW (w[Z][20] | w[w[Z][W[3][y]]][20] |
                  w[w[Z][W[4][y]]][20]), COL (w[Z][20] | w[w[Z][W[3][y]]][20] |
                  w[w[Z][W[4][y]]][20]));
              printf ("\n");
#endif
              if (solve (p))
...
/**/
  ...
  for (a = p; a < q; ++a)    // Search WXYZ-Wing Type 1, Almost Locked Set move Type 1a, Type 1b and Type 1c Apex unsolved Cell positions wise
  {
...
// WXYZ-Wing Type 1 Transport
        ...
        if (B[g[K[0]]] == 3 && B[g[K[5] = K[2] - K[0] + K[4]]] == 2 &&
                             // Check Apex Cell values three digits; and 3rd Wing Cell values two digits; and
          B[g[K[0]] | g[K[5]]] == 4 &&
        ...
        {                    // Search Almost Locked Set move Type 1b 3rd Wing Cell position Line wise
          ...
          {                  // Search 3rd Wing Cell position 1st (or 2nd) Wing Box+Line wise
            ...
            int k[12] = {K[2 << Y] - COL (w[K[2 << Y]][20]) + COL (w[K[6]][20]),
                        K[6] - COL (w[K[6]][20]) + COL (w[K[2 << Y]][20]),-1,-1};
  ...
  for (a = p; a < q; ++a)    // Search WXYZ-Wing Type 2a, Type 2b, Type 3, Type 4a, Type 4b, Almost Locked Set move Type 2a and Type 2b Apex unsolved Cell positions wise
  {
...
// WXYZ-Wing Type 2a, Type 2b and Type 3 Transport
          ...
          {                  // Search 2nd Apex Cell position mini-Line wise
            ...
            {                // Check no Wing Cells common value in Apex Cells values
              Z = W[K[3] < W[5][y] ? 1 : 5][y];
                             // Assign Wing Cells common 1st removal Cell position
              k[1] = g[w[K[2]][Z]];
              k[2] = g[w[K[2]][Z + 1]];
              k[3] = g[w[K[2]][Z + 2]];
...
/**
          ...
          {                  // Search Almost Locked Set move Type 2a 3rd Wing Cell position 1st Wing Box and 2nd Wing Line wise
            ...
            if (B[g[K[0]]] != 3 || B[g[K[2]]] != 2 || B[g[K[4]]] != 2 ||
                             // Check Apex Cell values not three digits; or 1st Wing Cell values not two digits; or 2nd Wing Cell values not two digits; or
              (g[K[2]] & g[K[4]]) || !B[g[K[5] = w[K[2]][Y]]] ||
                             // 1st and 2nd Wing Cells common digit; or 3rd Wing Cell position not unsolved; or
              B[g[K[5]]] > 3 || B[g[K[0]] | g[K[5]]] != 4 ||
                             //  3rd Wing Cell values > three digits; or Apex and 3rd Wing Cells values not four digits; or
              (B[g[K[2]] | g[K[5]]] != 3 && B[g[K[4]] & g[K[5]]] != 1) ||
                             // (1st and 3rd Wing Cells values not three digits; and 2nd and 3rd Wing Cells values not one common digits); or
              (B[g[K[4]] | g[K[5]]] != 3 && B[g[K[2]] & g[K[5]]] != 1))
              continue;      // (2nd and 3rd Wing Cells values not three digits; and 1st and 3rd Wing Cells values not one common digits)
            K[6] = W[K[3] < W[5][y] ? 5 : 1][y];
            K[7] = W[K[1] == W[6][y] || K[1] == W[7][y] || K[1] == W[8][y] ? 4 : 3][!y];
            X = B[g[K[0]] & g[K[2]]] == 2;
            if (B[g[K[5]]] < 3 ? (g[Z = w[K[0]][K[6 | X]]] | g[w[Z][W[3][y]]] |
              g[w[Z][W[4][y]]] | g[w[K[0]][W[3][y]]] | g[w[K[0]][W[4][y]]]) &
              (L = ~g[K[5]] & g[K[4 >> X]]) : 0 ||
...
/**/
          ...
          {                  // Search Almost Locked Set move Type 2a 3rd Wing Cell position 1st Wing Box and 2nd Wing Line wise
            ...
            if (B[g[K[0]]] != 3 || B[g[K[2]]] != 2 || B[g[K[4]]] != 2 ||
                             // Check Apex Cell values not three digits; or 1st Wing Cell values not two digits; or 2nd Wing Cell values not two digits; or
              (g[K[2]] & g[K[4]]) || B[g[K[5] = w[K[2]][Y]]] != 2 ||
                             // 1st and 2nd Wing Cells common digit; or 3rd Wing Cell values not two digits; or
              B[g[K[2]] | g[K[5]]] != 3 || B[g[K[4]] | g[K[5]]] != 3 ||
                             // 1st and 3rd Wing Cells values not three digits; or 2nd and 3rd Wing Cells values not three digits; or
              B[g[K[0]] | g[K[5]]] != 4)
              continue;      // Apex and 3rd Wing Cells values not four digits
            K[6] = W[K[3] < W[5][y] ? 5 : 1][y];
            K[7] = W[K[1] == W[6][y] || K[1] == W[7][y] || K[1] == W[8][y] ? 4 : 3][!y];
            X = B[g[K[0]] & g[K[2]]] == 2;
          ...
          if (B[g[K[0]]] > 3 || B[g[K[2]]] != 2 || B[g[K[4]]] != 2 ||
                             // Skip for either Apex Cell values > three digits; or 1st Wing Cell values not two digits; or 2nd Wing Cell values not two digits; or
            B[g[K[0]] & g[K[2]]] != 1 || B[g[K[0]] | g[K[4]]] != 3 || (g[K[2]] & g[K[4]]))
            continue;        // One common digit not in Apex and 1st Wing Cells values; or Apex and 2nd Wing Cells values not three digits; or common value in 2nd and 3rd Wing Cell values
