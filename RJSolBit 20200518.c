...
int solve (int p)
{
    ...
    for (a = 0; a < 36; ++a) // Search Naked/Hidden pair Cell values Unit 36 pair Cell positions wise
    {
      ...
      if (B[K[0]] == 2)      // Check Naked pair Cell values in Unit pair Cell positions
      {
        ...
        if (solve (p))
          return 1;
#if RJ > 2
        printf ("%d) Undo Naked pair: %s %d wise %d @ %s %s <= +%d @ %s %s %s %s %s %s %s\n",
          p, RCB, LBN (l[y][h[a][0]]), b[K[0]], S[l[y][h[a][0]]], S[l[y][h[a][1]]],
          b[K[0]], S[l[y][h[a][2]]], S[l[y][h[a][3]]], S[l[y][h[a][4]]],
          S[l[y][h[a][5]]], S[l[y][h[a][6]]], S[l[y][h[a][7]]], S[l[y][h[a][8]]]);
#endif
      ...
      if (solve (p))
        return 1;
#if RJ > 2
      printf ("%d) Undo Hidden pair: %s %d wise %d @ %s %s <=",
        p, RCB, LBN (l[y][h[a][0]]), b[K[0]], S[l[y][h[a][0]]], S[l[y][h[a][1]]]);
      if (k[0] ^ (k[0] & K[0]))
        printf (" +%d @ %s", b[k[0] ^ (k[0] & K[0])], S[l[y][h[a][0]]]);
      if (k[1] ^ (k[1] & K[0]))
    ...
    for (; a < 120; ++a)     // Search Naked/Hidden triplet Cell values Unit 84 triplet Cell positions wise
    {
      ...
      if (B[K[0]] == 3)      // Check Naked triplet Cell values in Unit triplet Cell positions
      {
        ...
        if (solve (p))
          return 1;
#if RJ > 2
        printf ("%d) Undo Naked triplet: %s %d wise %d @ %s %s %s <= +%d @ %s %s %s %s %s %s\n",
          p, RCB, LBN (l[y][h[a][0]]), b[K[0]], S[l[y][h[a][0]]], S[l[y][h[a][1]]],
          S[l[y][h[a][2]]], b[K[0]], S[l[y][h[a][3]]], S[l[y][h[a][4]]],
          S[l[y][h[a][5]]], S[l[y][h[a][6]]], S[l[y][h[a][7]]], S[l[y][h[a][8]]]);
#endif
      ...
      if (solve (p))
        return 1;
#if RJ > 2
      printf ("%d) Undo Hidden triplet: %s %d wise %d @ %s %s %s <=",
        p, RCB, LBN (l[y][h[a][0]]), b[K[0]], S[l[y][h[a][0]]], S[l[y][h[a][1]]], S[l[y][h[a][2]]]);
      if (k[0] ^ (k[0] & K[0]))
        printf (" +%d @ %s", b[k[0] ^ (k[0] & K[0])], S[l[y][h[a][0]]]);
      if (k[1] ^ (k[1] & K[0]))
    ...
    for (; a < 246; ++a)     // Search Naked/Hidden quad Cell values Unit 126 quad Cell positions wise
    {
      ...
      if (B[K[0]] == 4)      // Check Naked quad Cell values in Unit quad Cell positions
      {
        ...
        if (solve (p))
          return 1;
#if RJ > 2
        printf ("%d) Undo Naked quad: %s %d wise %d @ %s %s %s %s <= +%d @ %s %s %s %s %s\n",
          p, RCB, LBN (l[y][h[a][0]]), b[K[0]], S[l[y][h[a][0]]], S[l[y][h[a][1]]],
          S[l[y][h[a][2]]], S[l[y][h[a][3]]], b[K[0]], S[l[y][h[a][4]]], S[l[y][h[a][5]]],
          S[l[y][h[a][6]]], S[l[y][h[a][7]]], S[l[y][h[a][8]]]);
#endif
      ...
      if (solve (p))
        return 1;
#if RJ > 2
      printf ("%d) Undo Hidden quad: %s %d wise %d @ %s %s %s %s <=",
        p, RCB, LBN (l[y][h[a][0]]), b[K[0]], S[l[y][h[a][0]]], S[l[y][h[a][1]]], S[l[y][h[a][2]]], S[l[y][h[a][3]]]);
      if (k[0] ^ (k[0] & K[0]))
        printf (" +%d @ %s", b[k[0] ^ (k[0] & K[0])], S[l[y][h[a][0]]]);
      if (k[1] ^ (k[1] & K[0]))
    ...
    for (y = 0; y < 2; ++y)  // Search either away Line or away Box 6 Cell positions wise
    {
      ...
      {                      // Search Almost Locked Pair 1st Cell position 54 mini-Lines away Line/Box 6 Cell positions wise
        ...
        if (solve (p))
          return 1;
#if RJ > 2
        printf ("%d) Undo Almost Locked Pair: Box %d %s %d wise %d @ r%dc%d %s %s\n<= +%d @ ",
          p, BOX (j[a][y ? A : Z]), a < 27 ? "Row" : "Column",
          a < 27 ? ROW (w[j[a][y ? Z : A]][20]) : COL (w[j[a][y ? Z : A]][20]),
          b[Y], ROW (w[j[a][0]][20] | w[j[a][1]][20] | w[j[a][2]][20]),
          COL (w[j[a][0]][20] | w[j[a][1]][20] | w[j[a][2]][20]),
          ...
          {                  // Search 3rd Cell position 54 mini-Lines away Box/Line wise
            ...
            {                // Search 4th Cell position 54 mini-Lines away Box/Line wise
              if (!g[j[a][N]] || (g[j[a][M]] | g[j[a][N]]) != Y ||
                             // Skip for either 4th Cell position not unsolved; or 3rd and 4th Cells values not 1st and 2nd Cells values; or
              ...
              if (solve (p))
                return 1;
#if RJ > 2
              printf ("%d) Undo Almost Locked Triple: Box %d %s %d wise %d @ r%dc%d r%dc%d %s %s\n<= +%d @ ",
                p, BOX (j[a][y ? A : M]), a < 27 ? "Row" : "Column",
                a < 27 ? ROW (w[j[a][y ? M : A]][20]) : COL (w[j[a][y ? M : A]][20]),
                b[Y], ROW (w[j[a][0]][20] | w[j[a][1]][20] | w[j[a][2]][20]),
                COL (w[j[a][0]][20] | w[j[a][1]][20] | w[j[a][2]][20]),
              ...
              {              // Search 5th Cell position 54 mini-Lines away Box/Line wise
                ...
                {            // Search 6th Cell position 54 mini-Lines away Box/Line wise
                  ...
                  if (solve (p))
                    return 1;
#if RJ > 2
                  printf ("%d) Undo Almost Locked Quad: Box %d %s %d wise %d @ r%dc%d r%dc%d %s %s %s\n<= +%d @ ",
                    p, BOX (j[a][y ? A : N]), a < 27 ? "Row" : "Column",
                    a < 27 ? ROW (w[j[a][y ? N : A]][20]) : COL (w[j[a][y ? N : A]][20]),
                    b[Y], ROW (w[j[a][0]][20] | w[j[a][1]][20] | w[j[a][2]][20]),
                    COL (w[j[a][0]][20] | w[j[a][1]][20] | w[j[a][2]][20]),
    ...
    {                        // Search Basic Fishes digit wise
      ...
      {                      // Search X-Wing value for Line 36 pair Cell positions
        ...
        if (solve (p))
          return 1;
#if RJ > 2
        printf ("%d) Undo X-Wing: %s wise %d @ r%d%dc%d%d\n",
          p, RCB, b[Y], y ? b[K[0]] : h[a][0] + 1, y ? b[K[1]] : h[a][1] + 1,
          y ? h[a][0] + 1 : b[K[0]], y ? h[a][1] + 1 : b[K[1]]);
#endif
        for (Z = 0; Z < 2; ++Z)
      ...
      for (; a < 120; ++a)   // Search Sword Fish value in Line 84 triplet Cell positions
      {
        ...
        if (solve (p))
          return 1;
#if RJ > 2
        printf ("%d) Undo Sword Fish: %s wise %d @ r%d%d%dc%d%d%d\n",
          p, RCB, b[Y], y ? b[K[0]] : h[a][0] + 1, y ? b[K[1]] : h[a][1] + 1,
          y ? b[K[2]] : h[a][2] + 1, y ? h[a][0] + 1 : b[K[0]],
          y ? h[a][1] + 1 : b[K[1]], y ? h[a][2] + 1 : b[K[2]]);
#endif
      ...
      for (; a < 246; ++a)   // Search Jelly Fish value in Line 126 quad Cell positions
      {
        ...
        if (solve (p))
          return 1;
#if RJ > 2
        printf ("%d) Undo Jelly Fish: %s wise %d @ r%d%d%d%dc%d%d%d%d\n",
          p, RCB, b[Y], y ? b[K[0]] : h[a][0] + 1, y ? b[K[1]] : h[a][1] + 1,
          y ? b[K[2]] : h[a][2] + 1, y ? b[K[3]] : h[a][3] + 1, y ? h[a][0] + 1 : b[K[0]],
          y ? h[a][1] + 1 : b[K[1]], y ? h[a][2] + 1 : b[K[2]], y ? h[a][3] + 1 : b[K[3]]);
#endif
  ...
  for (a = 0; a < 81; ++a)   // Search 2-String Kite and Grouped 2-String Kite with ERI Ring, ERI and Box Grid wise
  {
    ...
    {                        // Search 2-String Kite and Grouped 2-String Kite with ERI Ring and ERI digit wise
      ...
      printf (" and %d @ %s Column %d between %d @ ", b[Y], S[K[3]], COL (w[a][20]), b[Y]);
          ...
          {                  // No ERI digit found in six Line Cell positions
            ...
            {                // Dual Linked Empty Rectangle removals
              ...
              if (solve (p))
                return 1;
#if RJ > 2
              printf ("%d) Undo Dual Linked Empty Rectangle: ERI %d @ b%d%s and ERI %d @ b%d%s SL %s %d between %d @ %s and %d @ %s\n<= +%d @ r%dc%d r%dc%d\n",
                p, b[K[1]], BOX (a), S[a], b[K[1]], BOX (K[7]), S[K[7]], R_C, RCN (K[2]),
                b[K[1]], S[K[2]], b[K[1]], S[w[K[2]][W[1][y] + b[~K[3] & 63] - 1]],
                b[K[1]], ROW (w[K[7]][20] | w[w[K[7]][K[5]]][20] |
                w[w[K[7]][K[5] + 1]][20] | w[w[K[7]][K[5] + 2]][20] |
            ...
            if (solve (p))
              return 1;
#if RJ > 2
            printf ("%d) Undo Empty Rectangle: ERI %d @ b%d%s SL %s %d between %d @ %s and %d @ %s <= +%d @ %s\n",
              p, b[K[1]], BOX (a), S[a], R_C, RCN (K[2]), b[K[1]], S[K[2]],
              b[K[1]], S[w[K[2]][W[1][y] + b[~K[3] & 63] - 1]], b[K[1]], S[K[7]]);
            if (!(g[w[K[7]][W[3][!y]]] & K[1]) + !(g[w[K[7]][W[4][!y]]] & K[1]) +
              !(g[w[K[7]][W[1][!y]]] & K[1]) + !(g[w[K[7]][W[18][!y]]] & K[1]) +
      ...
      {                      // Search 2nd Wing Cell position Column wise
        ...
        {                    // Check Strong Wing Type 1 for conjugate pair digit in 1st Wing and removal Cells values same as 2nd Wing and removal Cells values
          ...
          printf ("%d) Strong Wing Type 1: SL %d @ r%dc%d %d @ r%dc%d %d @ r%dc%d r%dc%d => -%d @ %s => -%d @ %s %s\n",
            ...
            ROW (w[K[4]][20] | w[K[5]][20]), COL (w[K[4]][20] | w[K[5]][20]),
            b[Z - Y], S[K[5]], b[Y], S[K[2]], S[K[4]]);
#endif
          if (solve (p))
            return 1;
#if RJ > 2
          printf ("%d) Undo Strong Wing Type 1: SL %d @ r%dc%d %d @ r%dc%d %d @ r%dc%d r%dc%d <= +%d @ %s <= +%d @ %s %s\n",
            p, b[K[6]], ROW (w[K[0]][20] | w[K[2]][20]), COL (w[K[0]][20] | w[K[2]][20]),
            b[K[7]], ROW (w[K[0]][20] | w[K[4]][20]), COL (w[K[0]][20] | w[K[4]][20]),
            b[Y], ROW (w[K[2]][20] | w[K[5]][20]), COL (w[K[2]][20] | w[K[5]][20]),
            ROW (w[K[4]][20] | w[K[5]][20]), COL (w[K[4]][20] | w[K[5]][20]),
          ...
          {                  // Search removal Cell position 1st Wing Line and 2nd Wing Box intersection wise
            ...
            {                // Check Strong Wing Type 2 for conjugate pair digit in 1st Wing and removal Cells values same as 2nd Wing and removal Cells values
              ...
              printf ("%d) Strong Wing Type 2: SL %d @ r%dc%d %d @ %s %s %d @ %s %s %d @ r%dc%d => -%d @ %s => -%d @ %s %s\n",
                p, b[K[6]], ROW (w[K[0]][20] | w[K[2]][20]), COL (w[K[0]][20] | w[K[2]][20]),
                b[K[7]], S[K[0]], S[K[4]], b[K[8]], S[K[2]], S[K[5]], b[K[9]],
                ROW (w[K[4]][20] | w[K[5]][20]), COL (w[K[4]][20] | w[K[5]][20]),
                b[Z - Y], S[K[5]], b[Y], S[K[2]], S[K[4]]);
#endif
              if (solve (p))
                return 1;
#if RJ > 2
              printf ("%d) Undo Strong Wing Type 2: SL %d @ r%dc%d %d @ %s %s %d @ %s %s %d @ r%dc%d <= +%d @ %s <= +%d @ %s %s\n",
                p, b[K[6]], ROW (w[K[0]][20] | w[K[2]][20]), COL (w[K[0]][20] | w[K[2]][20]),
                b[K[7]], S[K[0]], S[K[4]], b[K[8]], S[K[2]], S[K[5]], b[K[9]],
                ROW (w[K[4]][20] | w[K[5]][20]), COL (w[K[4]][20] | w[K[5]][20]),
                b[Z - Y], S[K[5]], b[Y], S[K[2]], S[K[4]]);
...
XYWT1Tf:
        ...
        {                    // No Wing Cells common value in 1st Wing and Hybrid Cells Column other Cells values
                             // Backup and drop Wing Cells common value from XYZ-Hybrid Row wise removal Cells values
          k[0] = g[w[K[0]][6]];
          k[2] = g[w[K[0]][7]];
          k[3] = g[w[K[2]][6]];
          k[4] = g[w[K[2]][7]];
        ...
        {                    // No Wing Cells common value in 2nd Wing and Hybrid Cells Row other Cells values
                             // Backup and drop Wing Cells common value from XYZ-Hybrid Column wise removal Cells values
          k[1] = g[w[K[0]][12]];
          k[8] = g[w[K[0]][13]];
          k[9] = g[w[K[4]][12]];
          k[10] = g[w[K[4]][13]];
        ...
        {                    // Search 2nd Wing Cell position Box wise but not in 1st Wing Line
          ...
          {                  // Search XY-Wing Type 2 Transport and XYZ-Wing Transport
            ...
            if (B[g[K[0]]] > 2)
            {
              ...
              {              // Line 01, Box 02, Reduced Line 1a
...
#if RJ > 2
                printf ("%d) XYZ-Wing Transport:%s%s %d @ r%dc%d %s SL %s %d between %d @ r%dc%d and %d @ r%dc%d\n=> -%d @ r%dc%d",
                  p, k[3] + 1 ? " Reduced " : " ", k[29] ? R_C : "Box", b[g[K[0]]],
                  ROW (w[K[0]][20] | w[K[2]][20]), COL (w[K[0]][20] | w[K[2]][20]),
                  S[K[4]], k[29] ? R_C : "Box", k[29] ? RCN (w[K[4]][K[7]]) :
                  BOX (w[K[4]][K[7]]), b[K[5]], ROW (w[X][20] | (k[3] + 1 ? 0 :
                  w[w[X][W[3][y]]][20] | w[w[X][W[4][y]]][20])), COL (w[X][20] |
                  (k[3] + 1 ? 0 : w[w[X][W[3][y]]][20] | w[w[X][W[4][y]]][20])),
                  b[K[5]], ROW (w[Z][20] | w[w[Z][W[3][y]]][20] | w[w[Z][W[4][y]]][20]),
                  COL (w[Z][20] | w[w[Z][W[3][y]]][20] | w[w[Z][W[4][y]]][20]), b[K[5]],
                ...
                if (solve (p))
                  return 1;
#if RJ > 2
                printf ("%d) Undo XYZ-Wing Transport:%s%s %d @ r%dc%d %s SL %s %d between %d @ r%dc%d and %d @ r%dc%d\n<= +%d @ r%dc%d\n",
                  p, k[3] + 1 ? " Reduced " : " ", k[29] ? R_C : "Box", b[g[K[0]]],
                  ROW (w[K[0]][20] | w[K[2]][20]), COL (w[K[0]][20] | w[K[2]][20]),
                  S[K[4]], k[29] ? R_C : "Box", k[29] ? RCN (w[K[4]][K[7]]) :
                  BOX (w[K[4]][K[7]]), b[K[5]], ROW (w[X][20] | (k[3] + 1 ? 0 :
              ...
              {              // Line 03, Box 04
                ...
                g[w[K[0]][K[7] + 2]] &= ~K[5];
#if RJ > 2
                printf ("%d) XYZ-Wing Transport: %s %d @ r%dc%d %s SL %s %d between %d @ r%dc%d and %d @ r%dc%d\n=> -%d @ r%dc%d\n",
                  p, k[29] ? R_C : "Box", b[g[K[0]]], ROW (w[K[0]][20] | w[K[2]][20]),
                  COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], k[29] ? R_C : "Box",
                  k[29] ? RCN (w[K[4]][K[7]]) : BOX (w[K[4]][K[7]]), b[K[5]],
                  ROW (w[X][20] | w[w[X][W[3][y]]][20]| w[w[X][W[4][y]]][20]),
                  COL (w[X][20] | w[w[X][W[3][y]]][20]| w[w[X][W[4][y]]][20]), b[K[5]],
                  ROW (w[Z][20] | w[w[Z][W[3][y]]][20]| w[w[Z][W[4][y]]][20]),
                  COL (w[Z][20] | w[w[Z][W[3][y]]][20]| w[w[Z][W[4][y]]][20]),
                ...
                if (solve (p))
                  return 1;
#if RJ > 2
                printf ("%d) Undo XYZ-Wing Transport: %s %d @ r%dc%d %s SL %s %d between %d @ r%dc%d and %d @ r%dc%d\n<= +%d @ r%dc%d\n",
                  p, k[29] ? R_C : "Box", b[g[K[0]]], ROW (w[K[0]][20] | w[K[2]][20]),
                  COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], k[29] ? R_C : "Box",
                  k[29] ? RCN (w[K[4]][K[7]]) : BOX (w[K[4]][K[7]]), b[K[5]],
                  ROW (w[X][20] | w[w[X][W[3][y]]][20]| w[w[X][W[4][y]]][20]),
            ...
            {                // Line Ring 05, 07, Box Ring 06, 08, Reduced Line Ring 09, 10, 11, 12
              ...
              g[w[M][W[4][y]]] &= Y;
              if (w[K[0]][K[8]] == M)
              {              // Line Ring 07, Box Ring 08, Reduced Line Ring 09, 11, 12
                k[17] = g[w[K[4]][W[1][!y]]];
                k[18] = g[w[K[4]][W[18][!y]]];
                k[19] = g[w[K[4]][W[19][!y]]];
                k[20] = g[w[K[4]][W[20][!y]]];
...
#if RJ > 2
              printf ("%d) XY%s Transport:%s%s Ring %d @ r%dc%d %s SL %s %d between %d @ r%dc%d and %d @ r%dc%d\n=> -%d @ r%dc%d r%dc%d",
                p, B[g[K[0]]] < 3 ? "-Wing Type 2" : "Z-Wing",
                (k[15] | k[16]) ? " Reduced " : " ", k[29] ? R_C : "Box",
                b[g[K[2]] | g[K[4]]], ROW (w[K[0]][20] | w[K[2]][20]),
                COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], k[29] ? R_C : "Box",
                k[29] ? RCN (M) : BOX (M), b[K[5]],
                ROW (w[X][20] | w[w[X][W[3][y]]][20] | w[w[X][W[4][y]]][20]),
                COL (w[X][20] | w[w[X][W[3][y]]][20] | w[w[X][W[4][y]]][20]),
                b[K[5]], ROW (w[Z][20] | w[w[Z][W[3][y]]][20] | w[w[Z][W[4][y]]][20]),
                COL (w[Z][20] | w[w[Z][W[3][y]]][20] | w[w[Z][W[4][y]]][20]),
                b[K[5]], ROW (w[w[K[2]][W[3][y]]][20] | w[w[K[2]][W[4][y]]][20]),
                COL (w[w[K[2]][W[3][y]]][20] | w[w[K[2]][W[4][y]]][20]),
                ROW (w[w[K[4]][W[3][y]]][20] | w[w[K[4]][W[4][y]]][20] | (B[g[K[0]]] > 2 ?
                w[A][20] | w[w[A][W[3][y]]][20] | w[w[A][W[4][y]]][20] : 0)),
                COL (w[w[K[4]][W[3][y]]][20] | w[w[K[4]][W[4][y]]][20] | (B[g[K[0]]] > 2 ?
                w[A][20] | w[w[A][W[3][y]]][20] | w[w[A][W[4][y]]][20] : 0)));
              if (k[15])
                printf (" r%dc%d",
              ...
              if (solve (p))
                return 1;
#if RJ > 2
              printf ("%d) Undo XY%s Transport:%s%s Ring %d @ r%dc%d %s SL %s %d between %d @ r%dc%d and %d @ r%dc%d\n<= +%d @  r%dc%d r%dc%d",
                p, B[g[K[0]]] < 3 ? "-Wing Type 2" : "Z-Wing",
                (k[15] | k[16]) ? " Reduced " : " ", k[29] ? R_C : "Box",
                b[g[K[2]] | g[K[4]]], ROW (w[K[0]][20] | w[K[2]][20]),
                COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], k[29] ? R_C : "Box",
            ...
            for (Y = W[1][!y]; Y < W[2][!y]; ++Y)
            {
              ...
              {              // Line Ring 13, 14, ERI Ring 15, 16
                ...
                {
                  if (k[29])
                    printf (" r%dc%d", ROW (w[w[X][W[3][!y]]][20] | w[w[X][W[4][!y]]][20] |
                      w[w[Z][W[3][!y]]][20] | w[w[Z][W[4][!y]]][20]),
                      COL (w[w[X][W[3][!y]]][20] | w[w[X][W[4][!y]]][20] |
                      w[w[Z][W[3][!y]]][20] | w[w[Z][W[4][!y]]][20]));
                  else
                    printf (" r%dc%d", ROW (w[X][20] | w[Z][20] | w[w[Z][K[7]]][20] |
                      w[w[Z][K[7] + 1]][20] | w[w[Z][K[7] + 2]][20]),
                      COL (w[X][20] | w[Z][20] | w[w[Z][K[7]]][20] |
                      w[w[Z][K[7] + 1]][20] | w[w[Z][K[7] + 2]][20]));
                  if (B[g[K[0]]] > 2)
                    printf (" %s", S[w[K[4]][K[1]]]);
                  printf (" %s r%dc%d r%dc%d", S[w[K[2]][K[8]]],
                    ROW (w[w[K[2]][A]][20] | w[w[w[K[2]][A]][W[3][!y]]][20] |
                    w[w[w[K[2]][A]][W[4][!y]]][20]), COL (w[w[K[2]][A]][20] |
                    w[w[w[K[2]][A]][W[3][!y]]][20] | w[w[w[K[2]][A]][W[4][!y]]][20]),
                    ROW (w[w[K[4]][A]][20] | w[w[w[K[4]][A]][W[3][!y]]][20] |
                    w[w[w[K[4]][A]][W[4][!y]]][20]), COL (w[w[K[4]][A]][20] |
                ...
                for (A = 3; A < 5; ++A)
                  ...
                  {          // Line 17, ERI 18
                    ...
                    printf ("%d) XYZ-Wing Transport: %s %d @ r%dc%d %s SL %s %d between%s%d @ %s and%s%d @ %s\n=> -%d @ %s\n",
                      ...
                      COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], k[29] ? R_C : "ERI",
                      k[29] ? RCN (X) : BOX (X), k[29] ? " " : " ERI ", b[K[5]], S[X],
                      k[29] ? " " : " ERI ", b[K[5]], S[Z], b[K[5]], S[L]);
#endif
                    if (solve (p))
                      return 1;
#if RJ > 2
