        ...
        {                    // Search 2nd Wing Cell position Box wise but not in 1st Wing Line
          ...
          {                  // Search removal Cell position 1st Wing Line and 2nd Wing Box intersection wise
            ...
            {                // Check Strong Wing Type 2 for conjugate pair digit in 1st Wing and removal Cells values same as 2nd Wing and removal Cells values
              ...
              g[K[5]] = Y;
#if RJ > 2
              printf ("%d) Strong Wing Type 2: SL %d @ r%dc%d %d @ %s %s %d @ %s %s %d @ r%dc%d => -%d @ %s\n",
              ...
              if (solve (p))
                return 1;
#if RJ > 2
              printf ("%d) Undo Strong Wing Type 2: SL %d @ r%dc%d %d @ %s %s %d @ %s %s %d @ r%dc%d <= +%d @ %s\n",
                p, b[K[6]], ROW (w[K[0]][20] | w[K[2]][20]),
                COL (w[K[0]][20] | w[K[2]][20]), b[K[7]], S[K[0]], S[K[4]],
                b[K[8]], S[K[2]], S[K[5]], b[K[9]], ROW (w[K[4]][20] | w[K[5]][20]),
                COL (w[K[4]][20] | w[K[5]][20]), b[Z - Y], S[K[5]]);
              ...
              prn ();
#endif
              return 0;      // Undo Strong Wing Type 2 removal Cells values
            }
            if (K[0] > K[2] || K[0] > K[4] ||
          ...
          {                  // Search XY-Wing Type 2 Transport and XYZ-Wing Transport
            ...
            if (B[g[K[0]]] > 2)
            {
              ...
              {              // Line 01, Box 02, Reduced Line 1a
                ...
                printf ("%d) XYZ-Wing Transport:%s%s %d @ r%dc%d %s SL %d @ %s %d => -%d @ r%dc%d",
                  ...
                  b[g[K[0]]], ROW (w[K[0]][20] | w[K[2]][20]),
                  COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], b[K[5]], k[29] ? R_C : "Box",
                ...
                if (solve (p))
                  return 1;
#if RJ > 2
                printf ("%d) Undo XYZ-Wing Transport:%s%s %d @ r%dc%d %s SL %d @ %s %d <= +%d @ r%dc%d\n",
                  p, k[3] + 1 ? " Reduced " : " ", k[29] ? R_C : "Box",
                  b[g[K[0]]], ROW (w[K[0]][20] | w[K[2]][20]),
                  COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], b[K[5]], k[29] ? R_C : "Box",
                  k[29] ? RCN (w[K[4]][K[7]]) : BOX (w[K[4]][K[7]]), b[K[5]],
              ...
              {              // Line 03, Box 04
                ...
                printf ("%d) XYZ-Wing Transport: %s %d @ r%dc%d %s SL %d @ %s %d => -%d @ r%dc%d\n",
                  p, k[29] ? R_C : "Box", b[g[K[0]]], ROW (w[K[0]][20] | w[K[2]][20]),
                ...
                if (solve (p))
                  return 1;
#if RJ > 2
                printf ("%d) Undo XYZ-Wing Transport: %s %d @ r%dc%d %s SL %d @ %s %d <= +%d @ r%dc%d\n",
                  p, k[29] ? R_C : "Box", b[g[K[0]]], ROW (w[K[0]][20] | w[K[2]][20]),
                  COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], b[K[5]],
                  k[29] ? R_C : "Box", k[29] ? RCN (w[K[4]][K[7]]) : BOX (w[K[4]][K[7]]),
                  b[K[5]], ROW (w[w[K[0]][K[7]]][20] | w[w[K[0]][K[7] + 1]][20] |
            ...
            {                // Line Ring 05, Box Ring 06, Reduced Line Ring 07, 08, 09
...
#if RJ > 2
              printf ("%d) XY%s Transport:%s%s Ring %d @ r%dc%d %s\nSL %d @ %s %d => -%d @ %s %s %s %s",
                p, B[g[K[0]]] < 3 ? "-Wing Type 2" : "Z-Wing",
                k[15] ? " Reduced " : " ", k[29] ? R_C : "Box",
                b[g[K[2]] | g[K[4]]], ROW (w[K[0]][20] | w[K[2]][20]),
                COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], b[K[5]], k[29] ? R_C : "Box",
              ...
              if (solve (p))
                return 1;
#if RJ > 2
              printf ("%d) Undo XY%s Transport:%s%s Ring %d @ r%dc%d %s\nSL %d @ %s %d <= +%d @ %s %s %s %s",
                p, B[g[K[0]]] < 3 ? "-Wing Type 2" : "Z-Wing",
                k[15] ? " Reduced " : " ", k[29] ? R_C : "Box",
                b[g[K[2]] | g[K[4]]], ROW (w[K[0]][20] | w[K[2]][20]),
                COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], b[K[5]], k[29] ? R_C : "Box",
              ...
              {              // Line Ring 10, 12, ERI Ring 11, 13
...
#if RJ > 2
                printf ("%d) XY%s Transport: %s Ring %d @ r%dc%d %s SL value %d %s %d between Cell %s and Cell %s\n=> -%d @ %s",
                  p, B[g[K[0]]] < 3 ? "-Wing Type 2" : "Z-Wing", k[29] ? R_C : "ERI",
                  b[g[K[2]] | g[K[4]]], ROW (w[K[0]][20] | w[K[2]][20]),
                  COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], b[K[5]], k[29] ? R_C : "ERI",
                  k[29] ? RCN (X) : BOX (X), S[X], S[Z], b[K[5]], S[M]);
                if (B[g[K[0]]] < 3 || w[K[0]][K[8]] == M)
                {
                  if (k[29])
                ...
                printf ("\n");
                  ...
                  if (solve (p))
                    return 1;
#if RJ > 2
                printf ("%d) Undo XY%s Transport: %s Ring %d @ r%dc%d %s SL value %d %s %d between Cell %s and Cell %s\n<= +%d @ %s",
                  p, B[g[K[0]]] < 3 ? "-Wing Type 2" : "Z-Wing", k[29] ? R_C : "ERI",
                  b[g[K[2]] | g[K[4]]], ROW (w[K[0]][20] | w[K[2]][20]),
                  COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], b[K[5]], k[29] ? R_C : "ERI",
                  k[29] ? RCN (X) : BOX (X), S[X], S[Z], b[K[5]], S[M]);
              ...
              if (B[g[K[0]]] > 2 && w[K[0]][K[8]] != w[K[4]][N])
                for (A = 3; A < 5; ++A)
                  ...
                  {          // Line 14, ERI 15
                    g[L] -= K[5];
#if RJ > 2
                    printf ("%d) XYZ-Wing Transport: %s %d @ r%dc%d %s SL value %d %s %d between %s %s and %s %s\n=> -%d @ %s\n",
                      p, k[29] ? R_C : "ERI", b[g[K[0]]], ROW (w[K[0]][20] | w[K[2]][20]),
                      COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], b[K[5]], k[29] ? R_C : "ERI",
                      k[29] ? RCN (X) : BOX (X), k[29] ? "Cell" : "ERI", S[X],
                      k[29] ? "Cell" : "ERI", S[Z], b[K[5]], S[L]);
#endif
                    if (solve (p))
                      return 1;
#if RJ > 2
                    printf ("%d) Undo XYZ-Wing Transport: %s %d @ r%dc%d %s SL value %d %s %d between %s %s and %s %s\n<= +%d @ %s\n",
                      p, k[29] ? R_C : "ERI", b[g[K[0]]], ROW (w[K[0]][20] | w[K[2]][20]),
                      COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], b[K[5]], k[29] ? R_C : "ERI",
                      k[29] ? RCN (X) : BOX (X), k[29] ? "Cell" : "ERI", S[X],
                      k[29] ? "Cell" : "ERI", S[Z], b[K[5]], S[L]);
              ...
              for (M = 0; M < 2; ++M)
              {
                  ...
                  for (A = K[7]; A < K[7] + 3; ++A)
                    ...
                    {        // Line 16, ERI 17, 18
...
#if RJ > 2
                      printf ("%d) XY%s Transport: %s %d @ r%dc%d %s SL value %d %s %d => -%d @ %s",
                        p, B[g[K[0]]] < 3 ? "-Wing Type 2" : "Z-Wing", k[29] ? R_C : "ERI",
                        b[g[K[2]] | g[K[4]]], ROW (w[K[0]][20] | w[K[2]][20]),
                        COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], b[K[5]],
                      ...
                      if (solve (p))
                        return 1;
#if RJ > 2
                      printf ("%d) Undo XY%s Transport: %s %d @ r%dc%d %s SL value %d %s %d <= +%d @ %s",
                        p, B[g[K[0]]] < 3 ? "-Wing Type 2" : "Z-Wing", k[29] ? R_C : "ERI",
                        b[g[K[2]] | g[K[4]]], ROW (w[K[0]][20] | w[K[2]][20]),
                        COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], b[K[5]],
                        k[29] ? R_C : "ERI Box", k[29] ? RCN (X) : BOX (X), b[K[5]], S[L]);
                ...
                for (A = 3; A < 5; ++A)
                  ...
                  {          // Line 19, 21, 23, 25 ERI 20, 22, 24, 26
...
#if RJ > 2
                    printf ("%d) XY%s Transport: %s %d @ r%dc%d %s SL value %d %s %d between Cell %s and Cell %s\n=> -%d @ %s",
                      p, B[g[K[0]]] < 3 ? "-Wing Type 2" : "Z-Wing", k[29] ? R_C : "ERI",
                      b[g[K[2]] | g[K[4]]], ROW (w[K[0]][20] | w[K[2]][20]),
                      COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], b[K[5]], k[29] ? R_C : "ERI",
                    ...
                    if (solve (p))
                      return 1;
#if RJ > 2
                    printf ("%d) Undo XY%s Transport: %s %d @ r%dc%d %s SL value %d %s %d between Cell %s and Cell %s\n<= +%d @ %s",
                      p, B[g[K[0]]] < 3 ? "-Wing Type 2" : "Z-Wing", k[29] ? R_C : "ERI",
                      b[g[K[2]] | g[K[4]]], ROW (w[K[0]][20] | w[K[2]][20]),
                      COL (w[K[0]][20] | w[K[2]][20]), S[K[4]], b[K[5]], k[29] ? R_C : "ERI",
                      k[29] ? RCN (X) : BOX (X), S[X], S[Z], b[K[5]], S[L]);
                ...
                {            // ERI 32, 33
                  ...
                  if (solve (p))
                    return 1;
#if RJ > 2
                  printf ("%d) Undo XY%s Transport: ERI %d @ r%dc%d %s SL ERI %d @ b%d%s <= +%d @ %s\n",
                    p, B[g[K[0]]] < 3 ? "-Wing Type 2" : "Z-Wing", b[g[K[2]] | g[K[4]]],
                    ROW (w[K[0]][20] | w[K[2]][20]), COL (w[K[0]][20] | w[K[2]][20]),
                    S[K[4]], b[K[5]], BOX (w[K[2 << M]][Y]), S[w[K[2 << M]][Y]],
                    b[K[5]], S[w[K[4 >> M]][Y]]);
  ...
  if (o == NULL)
    ...
    do
    {
      ...
      else if (m == 10 || m == EOF)
      {
        ...
        c = clock ();
        while (a < 80)       // Clear remaining clue Cell positions
          s[++a] = 0;
#if RJ > 4
        for (a = 0; a < 81; ++a)
        {
