  ...
  for (y = 0; y < 10; y += 9)// Search Basic Fishes Line wise
    ...
    {                        // Search Basic Fishes digit wise
      ...
      for (; a < 120; ++a)   // Search Sword Fish value in Line 84 triplet Cell positions
      {
        ...
        {                    // Skip for either no unsolved Cell positions; or no Sord Fish value in Lines triplet Cell positions found
      ...
      for (; a < 246; ++a)   // Search Jelly Fish value in Line 126 quad Cell positions
      {
        ...
        {                    // Skip for either no unsolved Cell positions; or no Jelly Fish value in Line quad Cell positions found
      ...
      {                      // Search 1st SL within 1st and 2nd chutes
        ...
        {                    // Search 2nd SL within 2nd and 3rd chutes
          ...
          {                  // Found 2nd SL Grouped Cover Cell positions
            if (A[5] || ~A[0] & 1)
              continue;      // Skip for either Grouped SL Cell positions already found; or no 1st SL Cell position in 1st mini-Line found
            A[3] = A[5] = 1;
          }
          ...
          {                  // Found 2nd SL Grouped Cover Cell positions
            if (A[5] || ~(A[0] | A[1]) & 2)
              continue;      // Skip for either Grouped Cover Cell positions already found; or no 1st SL Cell positions in 2nd mini-Line found
            A[3 + A[3]] = A[5] = 2;
          }
          if (!A[3])
          ...
          {                  // Found 2nd SL either one Cover or Base Cell position
            if (A[4] || ~A[1] & 4)
              continue;      // Skip for either 2nd SL Base and Cover Cell positions already found; or no 1st SL Cover Cell positions in 3rd mini-Line found
            A[4] = 4;
          }
          else if (A[6] < 2)
          {                  // Found 2nd SL Grouped Cover Cell positions
            if (A[4] || A[5] || ~(A[0] | A[1]) & 4)
              continue;      // Skip for either 2nd SL Base and Cover Cell positions already found; or Grouped Cover Cell positions already found; or no 1st SL Cover Cell positions in 3rd mini-Line found
            A[4] = A[5] = 4;
          }
          if (!A[4])
          ...
          int K[12] = {-1,-1,-1,-1,
              ...
              k[4] = {0};    // Backup Skyscraper and Grouped Skyscraper removal Cells values
...
/**
          int L,             // Skyscraper+ERI and Grouped Skyscraper+ERI
              X = y + (a < y + 3 ? (Z < y + 6 ? 6 : 3) : 0);
          ...
          for (L = X; L < X + 3; ++L)
          {
            ...
            k[0] = K[0] + 1 ? g[K[0]] : 0;
            k[1] = K[1] + 1 ? g[K[1]] : 0;
            if (!((k[0] | k[1]) & ERI (l[L][0]) & Y))
              continue;      // Skip for no Skyscraper+ERI and Grouped Skyscraper+ERI digit found in removal Cell positions
  ...
  for (a = 0; a < 81; ++a)   // Search 2-String Kite and Grouped 2-String Kite with ERI Ring, ERI and Box Grid wise
  {
    ...
    {                        // Search 2-String Kite and Grouped 2-String Kite with ERI Ring and ERI digit wise
      if (B[X = !(g[w[a][0]] & Y) | (!(g[w[a][1]] & Y) << 1) |
        ...
        continue;            // Skip for no digit found in either five Row Cells values; or five Column Cells values; or no removal Cell position
      ...
      {                      // Search 2-String Kite+ERI Ring and Grouped 2-String Kite+ERI Ring
        K[0] = g[K[5]];
        K[1] = g[w[K[3]][12]];
        K[2] = g[w[K[3]][13]];
        K[6] = g[L];
      ...
      else if (g[K[5]] & Y)  // 2-String Kite and Grouped 2-String Kite
        g[K[5]] -= Y;        // Drop digit from removal Cell values
      else if (LB3 (L, w[L][6], w[L][7], 1) & g[w[K[5]][6]] & Y)
                             // 2-String Kite+Box and Grouped 2-String Kite+Box
        g[K[5] = w[K[5]][K[2] = 6]] -= Y;
    ...
    for (y = 0; y < 2; ++y)  // Search 1st SL Line wise
    {
      ...
      {                      // M-Wing Type 1A, 1B, 2A, 2B, 2C, 2D, 3A, 3B, 4A, 4B
        if (!B[K[2] = g[K[3] = w[K[0]][K[1]]] & g[K[0]]] ||
          ...
          continue;          // no bivalue Cell values in Line another 1st SL Cell values found
    ...
    for (; K[1] < 6; ++K[1]) // Search 1st Wing Cell position Row wise
    {
      ...
      {                      // Search 2nd Wing Cell position Column wise
        ...
        for (y = 0; y < 2; ++y)
        {
          ...
          {                  // Box 53, Line 57, 69, Reduced Line Ring 61, 65
          ...
          {                  // Box 54, Line 58, 70, Reduced Line Ring 62, 66
        ...
        {                    // Search 2nd Wing Cell position Box wise but not 1st Wing Line
          ...
          if (B[g[K[0]]] < 3)// Search XY-Wing Type 2 Transport
          {
            ...
            if (((k[75] = LB3 (M = w[K[4]][N], w[X][K[1]], w[X][K[7]], y) & K[5]) ||
              ...
              (((g[w[K[2]][W[3][y]]] | g[w[K[2]][W[4][y]]] |
              g[w[K[4]][W[3][y]]] | g[w[K[4]][W[4][y]]] |
              (k[75] && (~(g[w[X][W[3][y]]] | g[w[X][W[4][y]]]) & K[5]) ?
...
XYWT2Tf:
            ...
            printf ("%d) XY%s Transport: %s%s%d @ r%dc%d %s\nSL value %d %s %d between Cell %s and",
              ...
              k[75] > 2 ? "ERI Box" : R_C, k[75] > 2 ? BOX (X) : RCN (X), S[X]);
            if (k[75] > 2)
          ...
          {                  // Search XYZ-Wing Transport
            ...
            {                // Line 01, Box 02
              ...
              if (solve (p))
                return 1;
#if RJ > 2
              printf ("%d) Undo XYZ-Wing Transport: %s %d @ %s %s %s SL value %d %s %d <= +%d @ r%dc%d\n",
                p, k[75] ? R_C : "Box", b[g[K[0]]], S[K[0]], S[K[2]], S[K[4]], b[K[5]],
                k[75] ? R_C : "Box", k[75] ? RCN (w[K[4]][K[7]]) : BOX (w[K[4]][K[7]]),
                b[K[5]], ROW (w[M][20] | w[w[M][W[3][y]]][20] | w[w[M][W[4][y]]][20]),
                COL (w[M][20] | w[w[M][W[3][y]]][20] | w[w[M][W[4][y]]][20]));
            ...
            {                // Line Ring 05, Box Ring 06, Reduced Line Ring 07, 08, 09
              ...
              if (k[15])     // Backup and drop Wing Cells common value from XYZ-Wing Transport removal Cell positions
              ...
              printf ("%d) XYZ-Wing Transport: %s%sRing %d @ %s %s %s\nSL %d @ %s %d => -%d @ %s %s %s %s %s %s %s",
                ...
                S[w[K[4]][W[4][y]]], S[A], S[w[A][W[3][y]]], S[w[A][W[4][y]]]);
              if (k[15])
                printf (" r%dc%d",
...
/**
            printf ("%d) XY%s Transport: %s%s%d @ %s %s %s SL ",
              p, B[g[K[0]]] < 3 ? "-Wing Type 2" : "Z-Wing",
              k[75] > 2 ? "ERI" : (k[75] > 1 ? "Box" : R_C), k[6] ? " Ring " : " ",
              b[g[K[2]] | g[K[4]]], S[K[0]], S[K[2]], S[K[4]]);
            if (k[75] > 2)
              printf ("ERI %d @ b%d", b[K[5]], BOX (A[0][0]));
            else
              printf ("Cell%s %d @ ", A[0][1] + 1 ? "s " : " ", b[K[5]]);
            ...
            if (k[75] > 2)
              printf (" and ERI %d @ b%d", b[K[5]], BOX (A[0][0]));
            else
              printf (" and Cell%s %d @ ", A[0][1] + 1 ? "s " : " ", b[K[5]]);
            printf ("%s", S[A[1][0]]);
            if (A[1][1] + 1)
            {
              printf (" %s", S[A[1][1]]);
...
/**/
          ...
          {                  // Check Wing Cells common value in XYZ-Wing Hybrid Cells values
            ...
            if (((g[w[K[0]][K[7]]] | g[w[K[0]][K[7] + 1]] | g[w[K[0]][K[7] + 2]]) & K[5]) &&
              ...
              g[w[K[2]][W[19][y]]] | g[w[K[2]][W[20][y]]] | g[w[K[21]][W[1][y]]] |
...
// WXYZ-Wing Type 1 Transport
        ...
        if (K[1] < 6 && K[3] > 13 && B[g[K[0]]] == 3 &&
                             // Check Almost Locked Set move Type 1a 1st Wing Cell position not Apex Box; and 2nd Wing Cell position not Apex Box; and Apex Cell values three digits; and
          B[g[K[2]]] == 2 && B[g[K[4]]] == 2 && !(g[K[2]] & g[K[4]]) &&
                             // 1st Wing Cell values two digits; and 2nd Wing Cell values two digits; and no common 1st and 2nd Wing Cells values; and
          B[g[K[5] = K[2] - K[0] + K[4]]] == 2 && B[g[K[2]] | g[K[5]]] == 3 &&
                             // 3rd Wing Cell values two digits; and 1st and 3rd Wing Cells values three digits; and
          B[g[K[4]] | g[K[5]]] == 3 && B[g[K[0]] | g[K[5]]] == 4 &&
                             // 2nd and 3rd Wing Cells values three digits; and Apex and 3rd Wing Cells values four digits; and
        ...
        {                    // Almost Locked Set move Type 1a removal Cell values
          ...
          prn ();
#endif
          return 0;          // Undo Wing Cells common value to Almost Locked Set move Type 1a removal Cell values
        }
      }
    }
  }
    ...
    if (Z + 1)               // One Trivalue Cell position found
    {
      for (Y = g[Z]; y = Y & -Y; Y -= y)
        ...
        {                    // Digit found Row, Box or Column wise in two Cell positions
          ...
          prn ();
#endif
          return 0;          // Undo BUG+1 removal Cells values
        }
    }
#if RJ > 2
    else
