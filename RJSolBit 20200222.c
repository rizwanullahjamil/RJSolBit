...
int solve (int p)
{
  ...
  {
    if (!g[j[a][0]] + !g[j[a][1]] + !g[j[a][2]] > 2)
      continue;              // Skip for no unsolved Cell position > 2 in mini-Line
    int A,
        L,
        M,
        N,
    ...
    for (y = 0; y < 2; ++y)  // Search either away Line or away Box 6 Cell position wise
    {
      for (A = W[26][y]; A < W[32][y]; ++A)
        ...
        if (g[j[a][A]] && B[Y = g[j[a][A]] &
          ~(g[j[a][W[26][y] + (A < W[27][y])]] |
          g[j[a][W[27][y] + (A < W[28][y])]] |
          g[j[a][W[28][y] + (A < W[29][y])]] |
          g[j[a][W[29][y] + (A < W[30][y])]] |
          g[j[a][W[30][y] + (A < W[31][y])]])] == 2 &&
          ...
          B[g[j[a][A]]] > 2))// Found Almost Locked Pair Line/Box wise
        {
          ...
          printf ("%d) Almost Locked Pair: %s %d Box %d wise %d @ r%dc%d %s b%d%s\n=> -%d @ %s %s %s %s %s",
            p, a < 27 ? "Row" : "Column",
            a < 27 ? ROW (w[j[a][A]][20]) : COL (w[j[a][A]][20]), BOX (j[a][Z]),
          ...
          {                  // Search 3rd Cell position away Box/Line wise
            ...
            for (N = M + 1; N < W[32][!y]; ++N)
              ...
              if (g[j[a][N]] && (g[j[a][M]] | g[j[a][N]]) == Y &&
                ...
                B[g[j[a][A]] | g[j[a][L]]] > 3))
              {              // Almost Locked Triple values in removal Cell positions
                ...
                printf ("%d) Almost Locked Triple: %s %d Box %d wise %d @ r%dc%d r%dc%d b%d%s b%d%s\n=> -%d @ %s %s %s %s",
                  p, a < 27 ? "Row" : "Column",
                  a < 27 ? ROW (w[j[a][A]][20]) : COL (w[j[a][A]][20]), BOX (j[a][M]),
                  b[Y], ROW (w[j[a][0]][20] | w[j[a][1]][20] | w[j[a][2]][20]),
              ...
              {              // Search 5th Cell position 54 mini-Lines away Box/Line wise
                ...
                for (Z = X + 1; Z < W[32][!y]; ++Z)
                  ...
                  if (g[j[a][Z]] && (g[j[a][N]] | g[j[a][X]] | g[j[a][Z]]) == Y &&
                    ...
                    B[g[j[a][A]] | g[j[a][L]] | g[j[a][M]]] > 4))
                  {          // Almost Locked Quad values not in removal Cell positions
