...
static const int b[512] = {  // Bitwise to digit Cell values
  ...
  { 0, 8}, {12,20}, {1610612736,402653184}};
        ...
        {                    // Search Almost Locked Set move Type 1b 3rd Wing Cell position Line wise
          ...
          {                  // Search 3rd Wing Cell position 1st (or 2nd) Wing Box+Line wise
            if (w[K[6] = w[K[4 >> Y]][K[5]]][20] & w[K[2 << Y]][20] & W[15][Y] ||
                             // Skip for either 3rd Wing Cell position 2nd (or 1st) Wing Cell position within same Line; or
...
printf ("%d) Almost Locked Set move Type 1b: %d @ r%dc%d %s %s => -%d @ r%dc%d",
  ...
  COL (w[K[0]][20] | w[K[2 << Y]][20]), S[K[4 >> Y]], S[K[6]], K[7],
  ROW (w[k[0]][20] | (k[2] + 1 ? w[k[2]][20] | w[k[4]][20] : 0)),
  COL (w[k[0]][20] | (k[2] + 1 ? w[k[2]][20] | w[k[4]][20] : 0)));
if (B[g[K[0]]] < 3)
  printf (" r%dc%d", ROW (w[k[1]][20] | (k[3] + 1 ? w[k[3]][20] | w[k[5]][20] : 0)),
    COL (w[k[1]][20] | (k[3] + 1 ? w[k[3]][20] | w[k[5]][20] : 0)));
printf ("\n");
#endif
          }
        }
