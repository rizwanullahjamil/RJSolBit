...
TEMP:
  ...
  for (a = p; a < q; ++a)    // Search WXYZ-Wing Type 1, Almost Locked Set move Type 1a and Type 2a Apex unsolved Cell positions wise
  {
...
/**/
          if (B[g[K[0]] | g[K[4]]] != 3 || B[g[K[0]] & g[K[2]]] != 1)
            continue;        // Skip for either Apex and 2nd Wing Cells values not three digits; or one common digit not in Apex and 1st Wing Cells values
          for (Y = W[1][y]; Y < W[2][y]; ++Y)
          {                  // Search Almost Locked Set move Type 2b 3rd Wing Cell position 2nd Wing Line but not Box wise
            if (B[g[K[0]]] > 3 || B[g[K[2]]] != 2 || B[g[K[4]]] != 2 ||
              ...
              continue;      // Apex and 3rd Wing Cells values not four digits
#if RJ > 2
              printf ("%d) Almost Locked Set move Type 2b: %d @ r%dc%d r%dc%d => -%d @\n",
                p, b[g[K[2]] | g[K[4]]], ROW (w[K[0]][20] | w[K[4]][20]),
                COL (w[K[0]][20] | w[K[4]][20]), ROW (w[K[2]][20] | w[K[5]][20]),
                COL (w[K[2]][20] | w[K[5]][20]), b[g[K[4]] & g[K[5]]]);
#endif
