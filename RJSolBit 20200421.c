...
int solve (int p)
{
  ...
  for (y = p; y < q - 1; ++y)// Search W-Wing Type 1, Type 2 and W-Ring 1st Cell position unsolved Cell positions wise
  {
    ...
    {                        // Search W-Wing Type 1, Type 2 and W-Ring 2nd Cell position unsolved Cell positions wise
      ...
      {                      // Check W-Wing Type 2 1st and 2nd Cell positions either Band or Stack wise
      ...
      {                      // Search 2nd Wing Cell position Column wise
        if (!g[K[4] = w[K[0]][K[3]]] ||
          ...
          (K[6] & K[7]) || !g[K[5] = w[K[4]][K[1]]] ||
                             // Conjugate pair digit in Apex and 1st Wing same as Apex and 2nd Wing Cells values; or removal Cell not unsolved; or
          !(K[8] = (g[K[2]] & g[K[5]] & ~(g[w[K[2]][12]] |
          g[w[K[2]][13]] | g[w[K[5]][12]] | g[w[K[5]][13]] |
          g[Y = w[K[2]][K[3] < 17 ? 17 : 14]] | g[w[Y][12]] | g[w[Y][13]]))))
          continue;          // No conjugate pair digit in 1st Wing and removal Cell values
        if (K[9] = K[8] & g[K[4]] & g[K[5]] & ~(g[w[K[4]][6]] |
          g[w[K[4]][7]] | g[w[K[5]][6]] | g[w[K[5]][7]] |
          g[Y = w[K[4]][K[1] < 3 ? 3 : 0]] | g[w[Y][6]] | g[w[Y][7]]))
        {                    // Same conjugate pair digit in 2nd Wing and removal Cell values
          ...
          printf ("%d) Strong Wing Type 1: SL %d @ r%dc%d %d @ r%dc%d %d @ r%dc%d r%dc%d => -%d @ %s\n",
            ...
            b[K[9]], ROW (w[K[2]][20] | w[K[5]][20]), COL (w[K[2]][20] | w[K[5]][20]),
        ...
        if (K[0] > K[2] || K[0] > K[4] || ((K[6] | K[7]) & K[8]) ||
                             // Skip Strong Ring Type 1 for either duplicate search; or conjugate pair digit same; or
          !(K[9] = g[K[4]] & g[K[5]] & ~(g[w[K[4]][6]] |
          g[w[K[4]][7]] | g[w[K[5]][6]] | g[w[K[5]][7]] |
          g[Y = w[K[4]][K[1] < 3 ? 3 : 0]] | g[w[Y][6]] | g[w[Y][7]])) ||
                             // Conjugate pair digit not in 2nd Wing and removal Cells values; or
          ((K[6] | K[7] | K[8]) & K[9]) ||
                             // Conjugate pair digit in 2nd Wing and removal Cells values same; or
      ...
      {                      // Search 1st Wing Cell position Line wise
        ...
        {                    // Search 2nd Wing Cell position Box wise but not 1st Wing Line
          ...
          {                  // Search XY-Wing Type 2 Transport and XYZ-Wing Transport
            ...
            {
              M = w[K[4]][N];
              if (((k[75] = LB3 (K[4], w[K[4]][K[1]], w[K[4]][K[7]], y) & K[5]) ||
                (LB3 (w[K[0]][K[7]], w[M][K[7]], w[K[4]][K[7]], y) & K[5])) &&
                ((g[M] | g[w[M][W[3][y]]] | g[w[M][W[4][y]]] |
                (k[75] && (w[K[0]][20] & w[K[4]][20] & W[15][y]) &&
              ...
              {              // Line 01, Box 02, Reduced Line 1a
                ...
                g[w[M][W[3][y]]] &= ~K[5];
                g[w[M][W[4][y]]] &= ~K[5];
                if (k[75] && (w[K[0]][20] & w[K[4]][20] & W[15][y]) &&
                  (~(g[w[K[4]][W[3][y]]] | g[w[K[4]][W[4][y]]]) & K[5]))
                {            // Reduced Line 1a
                  k[3] = g[w[K[0]][W[1][!y]]];
                  k[4] = g[w[K[0]][W[18][!y]]];
          ...
          if (B[g[K[0]]] > 2)// Check Almost Locked Set move Type 2a for Apex Cell values three digits
          {
            ...
            {                // Search Almost Locked Set move Type 2a 3rd Wing Cell position 1st Wing Box and 2nd Wing Line wise
              if (!g[K[5] = w[K[2]][Y]] || B[g[K[5]]] > 3 || B[g[K[0]] | g[K[5]]] != 4 ||
                ...
                ((B[g[K[5]]] > 2 || !((g[Z = w[K[0]][K[6 | X]]] |
                g[w[Z][W[3][y]]] | g[w[Z][W[4][y]]] | g[w[K[0]][W[3][y]]] |
                g[w[K[0]][W[4][y]]]) & (L = ~g[K[5]] & g[K[4 >> X]]))) &&
              ...
              printf ("%d) Almost Locked Set move Type 2a: %d @ r%dc%d r%dc%d => -%d @ r%dc%d",
                ...
                COL (w[w[K[4 >> X]][W[3][y]]][20] | w[w[K[4 >> X]][W[4][y]]][20]));
              if (B[g[K[5]]] < 3)
              {
                printf (" -%d @ ", b[L]);
                if (X)
