  ...
  for (a = p; a < q; ++a)    // Search Strong Wing Type 1 and Strong Ring Type 1 Apex Cell unsolved Cell positions wise
  {
    ...
    for (; K[1] < 6; ++K[1]) // Search 1st Wing Cell position Row wise
    {
      ...
      {                      // Search 2nd Wing Cell position Column wise
        if (g[K[4] = w[K[0]][K[3]]] &&
                             // Check Strong Wing 2nd Wing Cell position unsolved; and
          (K[7] = (g[K[0]] & g[K[4]] & ~(g[w[K[0]][12]] |
          g[w[K[0]][13]] | g[w[K[4]][12]] | g[w[K[4]][13]] |
          g[Y = w[K[0]][K[3] < 17 ? 17 : 14]] | g[w[Y][12]] | g[w[Y][13]]))) &&
                             // Conjugate pair digit in Apex and 2nd Wing Cells values; and
          !(K[6] & K[7]) && g[K[5] = w[K[4]][K[1]]] &&
                             // Conjugate pair digit in Apex and 1st Wing not in Apex and 2nd Wing Cells values; and exclusion Cell unsolved; and
          (K[8] = (g[K[2]] & g[K[5]] & ~(g[w[K[2]][12]] |
          g[w[K[2]][13]] | g[w[K[5]][12]] | g[w[K[5]][13]] |
          g[Y = w[K[2]][K[3] < 17 ? 17 : 14]] | g[w[Y][12]] | g[w[Y][13]]))) &&
                             // Conjugate pair digit in 1st Wing and removal Cell values; and
          (K[8] &= g[K[4]] & g[K[5]] & ~(g[w[K[4]][6]] |
        ...
        {                    // Same conjugate pair digit in 2nd Wing and removal Cell values
          Z = g[K[5]];       // Backup end exclude from removal Cell values
          g[K[5]] = K[8];
#if RJ > 2
